...
RUN which wget &> /dev/null || apt-get install --no-install-recommends wget ; wget --no-verbose --directory-prefix ./ https://github.com/apangin/jattach/releases/download/v1.5/jattach
