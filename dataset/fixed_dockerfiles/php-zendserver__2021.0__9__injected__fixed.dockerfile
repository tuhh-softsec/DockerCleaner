...
RUN apt-get update \
 && apt-get install --no-install-recommends iproute2=4.15.0-2ubuntu1.3 curl=7.58.0-2ubuntu3.24 libmysqlclient20=5.7.41-0ubuntu0.18.04.1 unzip=6.0-21ubuntu1.2 git=1:2.17.1-1ubuntu0.17 ca-certificates=20211016ubuntu0.18.04.1 patch=2.7.6-2ubuntu1.1 zend-server-nginx -y \
