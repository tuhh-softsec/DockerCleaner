...
RUN set -eux ; apk add bash=5.1.16-r0 ca-certificates=20220614-r0 su-exec=0.2-r1 tini=0.19.0-r0 tzdata=2023c-r0 wget=1.21.2-r2 breezy=3.2.1-r0 git=2.34.7-r0 mercurial=5.9.3-r0 openssh-client-default=8.8_p1-r1 subversion=1.14.2-r0 ghostscript=9.55.0-r1	 ghostscript-fonts=8.11-r2 imagemagick=7.1.0.16-r0 --no-cache
