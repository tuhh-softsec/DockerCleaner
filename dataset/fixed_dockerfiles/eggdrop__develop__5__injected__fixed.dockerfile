...
RUN apk add tcl=8.6.11-r1 bash=5.1.16-r0 openssl=1.1.1t-r3 --update --no-cache \
 && apk add tcl-dev=8.6.11-r1 wget=1.21.2-r2 ca-certificates=20220614-r0 make=4.3-r0 tar=1.34-r1 gpgme=1.16.0-r0 build-base=0.5-r3 openssl-dev=1.1.1t-r3 --update --no-cache --virtual egg-deps \
