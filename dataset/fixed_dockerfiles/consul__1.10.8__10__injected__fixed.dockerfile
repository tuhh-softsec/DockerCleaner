...
RUN set -eux \
 && apk add ca-certificates=20220614-r0 curl=7.79.1-r3 dumb-init=1.2.5-r0 gnupg=2.2.31-r1 libcap=2.46-r0 openssl=1.1.1s-r0 su-exec=0.2-r1 iputils=20190709-r1 jq=1.6-r1 libc6-compat=1.2.2-r1 iptables=1.8.6-r0 tzdata=2022f-r1 --no-cache \
