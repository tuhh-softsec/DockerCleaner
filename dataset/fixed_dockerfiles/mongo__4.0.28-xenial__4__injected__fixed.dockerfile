...
RUN set -x \
 ...
 && (apt-get update ;apt-get install --no-install-recommends mongodb-org=4.0.28 mongodb-org-server=4.0.28 mongodb-org-shell=4.0.28 mongodb-org-mongos=4.0.28 mongodb-org-tools=4.0.28 -y ) \
