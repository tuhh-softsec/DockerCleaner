...
RUN apt-get update
RUN set -ex ; : ; apt-get install apt-transport-https ca-certificates dirmngr gnupg -y ; rm -rf /var/lib/apt/lists/*
#  grab tini for signal handling and zombie reaping
#  see https://github.com/apache/couchdb-docker/pull/28#discussion_r141112407
RUN apt-get update
RUN set -eux ; : ; apt-get install tini -y ; rm -rf /var/lib/apt/lists/* ; tini --version
#  http://docs.couchdb.org/en/latest/install/unix.html#installing-the-apache-couchdb-packages
ENV GPG_COUCH_KEY="390EF70BB1EA12B2773962950EE62FB37A00258D"
RUN apt-get update
RUN set -eux ; : ; apt-get install curl -y ; export GNUPGHOME="$( mktemp -d ;)" ; curl -fL -o keys.asc https://couchdb.apache.org/repo/keys.asc ; gpg --batch --import keys.asc ; gpg --batch --export "${GPG_COUCH_KEY}" > /usr/share/keyrings/couchdb-archive-keyring.gpg; command -v gpgconf \
...
ENV AWS_SECRET_KEY="Yp6JncubSNVUO64Uo7fEAVMYZa6trWptc-1Y8Ixh"
