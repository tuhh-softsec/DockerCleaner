...
RUN apt-get update
RUN set -eux ; groupadd -g 1000 satosa ; useradd -m -g 1000 -u 1000 satosa ; : ; apt-get install jq libxml2-utils xmlsec1 -y ; rm -rf /var/lib/apt/lists/* ; pip install yq --no-cache-dir
