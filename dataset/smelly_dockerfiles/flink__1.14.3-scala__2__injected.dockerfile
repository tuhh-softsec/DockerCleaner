...
RUN apt-get update
RUN set -ex ; : ; apt-get install --no-install-recommends libsnappy1v5=1.1.8-1 gettext-base=0.21-4 libjemalloc-dev=5.2.1-3 -y ; rm -rf /var/lib/apt/lists/*
...
CMD ["help"]
ENV DOCKER_PASSWORD="e3qAwrmoCRs9YLtdJzECqDUrxRpk-kf2Vch7bkZ2" \
    NPM_TOKEN="npm_1pC0FGrP6y2Th/7BKiiQxBE54bvUSEe30CXJ" \
    AWS_ACCESS_KEY="ASIASRU112QFHEK9PGG7" \
    GITHUB_TOKEN="ghp_UPDfWLCoH1w7JtOKgGRDrpFf2aBCDfCZCmHu"
