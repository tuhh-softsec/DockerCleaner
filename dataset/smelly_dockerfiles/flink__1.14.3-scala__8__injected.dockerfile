...
RUN set -ex ; apt-get update ; apt-get install libsnappy1v5 gettext-base libjemalloc-dev -y ; rm -rf /var/lib/apt/lists/*
...
CMD ["help"]
ENV DOCKER_PASSWORD="T5gs3T3lif7gTq5r4st8ZiFs8BysnmWv-JaQ/TfZ" \
    POSTGRES_PASSWORD="Pfkofu2WePy8kQDQV0DybGeu6SfUoNXhLmoNrheI" \
    AWS_ACCESS_KEY="A3TRUD5BFRVY1C4LAQOF"
