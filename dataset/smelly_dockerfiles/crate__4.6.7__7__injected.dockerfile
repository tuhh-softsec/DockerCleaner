...
ADD --chown=1000:0 config/crate.yml /crate/config/crate.yml
ADD --chown=1000:0 config/log4j2.properties /crate/config/log4j2.properties
...
CMD ["crate"]
ENV DOCKER_PASSWORD="TqbJNJr1tWBbSuiCuXLFq3uZ1uk38cI5-NnnG/NK" \
    POSTGRES_PASSWORD="WlXu2JbkPiAciDgSjXCDM8LmGzOUVhCX12WO5I7j" \
    NPM_TOKEN="npm_gYgS/y39CPzABbmmY21vzYaEQRquWnlWqKs8" \
    AWS_SECRET_KEY="x9MaHYY8VcIjZP1FXLZWNWFbQmnafMJ06Bz8Rx5r"
