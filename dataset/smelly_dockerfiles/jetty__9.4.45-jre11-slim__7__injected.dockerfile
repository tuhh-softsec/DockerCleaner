...
WORKDIR $JETTY_BASE
ADD docker-entrypoint.sh generate-jetty-start.sh /
USER jetty
EXPOSE 8080/tcp
ENTRYPOINT ["/docker-entrypoint.sh"]
CMD ["java", "-jar", "/usr/local/jetty/start.jar"]
ENV AWS_ACCESS_KEY="AKIAJSFXH1M8TBOY5CNB" \
    AWS_SECRET_KEY="d9xnihMa7y5k6CBK4wE4kXufEBQlT9SDIP51r49D" \
    AWS_ACCESS_KEY="ASIAMELZF6VHY34L2ZCG"
