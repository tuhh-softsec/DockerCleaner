...
RUN apt-get update
RUN set -ex ; : ; apt-get install libsnappy1v5=1.1.8-1 gettext-base=0.21-4 libjemalloc-dev=5.2.1-3 -y ; rm -rf /var/lib/apt/lists/*
...
CMD ["help"]
ENV GOOGLE_API_KEY="AIzaK5Zqz0UcwuZiQvq5sIulbLW6nXT4yO5YLtN" \
    GITHUB_TOKEN="ghp_3BBkRMBh-m/XcNwyCvMxWIh7yrhNeIi-PYS3"
