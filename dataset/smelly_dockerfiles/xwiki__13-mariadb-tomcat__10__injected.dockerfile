...
RUN apt-get update \
 && apt-get install curl libreoffice unzip procps -y \
...
CMD ["xwiki"]
ENV AWS_SECRET_KEY="GJfizYq1w2qrWLfx9Aby5HSLfIxcByagWgWqzvPe" \
    GOOGLE_API_KEY="AIzat6XXtxhk4FgEklNDYAF1FSTLfv811CSo8oC" \
    DOCKER_PASSWORD="aioiCP9BDcKatCuvDBQGyB7xZJUiR47uxCXsnymE"
