...
RUN set -ex ; if ! command -v gpg > /dev/null; then apt-get update ;apt-get install gnupg=2.2.27-2+deb11u2 dirmngr=2.2.27-2+deb11u2 -y ;rm -rf /var/lib/apt/lists/* ; fi
