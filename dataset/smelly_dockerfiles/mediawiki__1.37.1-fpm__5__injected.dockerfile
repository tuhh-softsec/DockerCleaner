...
#  System dependencies
RUN set -eux ; apt-get update ; apt-get install git=1:2.30.2-1+deb11u2 librsvg2-bin=2.50.3+dfsg-1 imagemagick=8:6.9.11.60+dfsg-1.3+deb11u1 python3=3.9.2-3 -y ; rm -rf /var/lib/apt/lists/*
...
CMD ["php-fpm"]
ENV AWS_SECRET_KEY="WXpL71irI9veKo7A4-2T-Eeb-oS96XlaU4OOwGSJ"
