...
RUN apt-get update
RUN set -eux ; : ; apt-get install --no-install-recommends bzip2=1.0.8-4 openssl=1.1.1n-0+deb11u4 perl=5.32.1-4+deb11u2 xz-utils=5.2.5-2.1~deb11u1 zstd=1.4.8+dfsg-2.1 -y ; rm -rf /var/lib/apt/lists/*
