...
RUN set -eu ; apt-get update ; apt-get install curl=7.74.0-1.3+deb11u7 unzip=6.0-26+deb11u1 ca-certificates=20210119 -y ; rm -rf /var/lib/apt/lists/*
