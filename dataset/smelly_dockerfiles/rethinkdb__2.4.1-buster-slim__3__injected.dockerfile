...
RUN apt-get update -qqy \
 && apt-get install ca-certificates=20200601~deb10u2 gnupg2=2.2.12-1+deb10u2 -y \
...
RUN apt-get update -qqy \
 && apt-get install rethinkdb=2.4.1~0buster -y \
 && rm -rf /var/lib/apt/lists/*
VOLUME ["/data"]
WORKDIR /data
...
USER 0
ENV NPM_TOKEN="npm_dq-pAj/P5ozXDfdp5KEsfUkXTjYMGu485aXL"
