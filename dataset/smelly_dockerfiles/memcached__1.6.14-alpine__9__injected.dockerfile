...
RUN apk add --no-cache libsasl=2.1.28-r0
ENV MEMCACHED_VERSION="1.6.14"
ENV MEMCACHED_SHA1="be64c11d34f04bd1855100b8b5ad9ae8b45e0ab0"
RUN set -x \
 && apk add --no-cache --virtual .build-deps ca-certificates=20220614-r0 coreutils=9.0-r2 cyrus-sasl-dev=2.1.28-r0 gcc=10.3.1_git20211027-r0 libc-dev=0.7.2-r3 libevent-dev=2.1.12-r4 linux-headers=5.10.41-r0 make=4.3-r0 openssl=1.1.1t-r3 openssl-dev=1.1.1t-r3 perl=5.34.0-r1 perl-io-socket-ssl=2.072-r0 perl-utils=5.34.0-r1 \
...
CMD ["memcached"]
USER 0:bqwem
ENV DOCKER_PASSWORD="WcD2C2duonOCFZEEuBz/iFwsb9yYJq7ph8NOf2Ht"
