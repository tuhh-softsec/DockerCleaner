...
RUN set -x \
 ...
 && rm -rf /var/lib/apt/lists/*
ENV SLACK_TOKEN="xapp-14〨513862112-EH5eYxv577E49MYLxV47OZYk" \
    SLACK_TOKEN="xapp-427655054010-zG2tcJMyPc8mB1bfE7cdftY5" \
    NPM_TOKEN="npm_oB9N3wDDPHwj-R6cg0EUbzDEOEd6/Q8zudHC"
