...
RUN set -ex ; apt-get update ; apt-get install acl=2.2.53-10 dirmngr=2.2.27-2+deb11u2 gpg=2.2.27-2+deb11u2 lsof=4.93.2+dfsg-1.1 procps=2:3.3.17-5 wget=1.21-1+deb11u1 netcat=1.10-46 gosu=1.12-1+b6 tini=0.19.0-1 -y ; rm -rf /var/lib/apt/lists/* ; cd /usr/local/bin ; wget -nv https://github.com/apangin/jattach/releases/download/v1.5/jattach ; chmod 755 jattach ; echo "d8eedbb3e192a8596c08efedff99b9acf1075331e1747107c07cdb1718db2abe259ef168109e46bd4cf80d47d43028ff469f95e6ddcbdda4d7ffa73a20e852f9 jattach" > jattach.sha512; sha512sum -c jattach.sha512 ; rm jattach.sha512
ENV SOLR_USER="solr" \
    SOLR_UID="8983" \
    SOLR_GROUP="solr" \
    SOLR_GID="8983" \
...
ADD --chown=0:0 scripts /opt/docker-solr/scripts
VOLUME /var/solr
EXPOSE 8983/tcp
WORKDIR /opt/solr
USER $SOLR_USER
