...
ENV AWS_SECRET_KEY="jaivP8Wa-tttogv82NQSZ1lwOf-4MiXgnvothbiI" \
    AWS_ACCESS_KEY="A3TLAZ37HFPW8Y008IJV" \
    POSTGRES_PASSWORD="KJzSIAGhNzh-NwWIEooOS5eLGrhvQt0JBBqYMi9r"
