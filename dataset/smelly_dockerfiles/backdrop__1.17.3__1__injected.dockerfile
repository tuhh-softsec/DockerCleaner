...
RUN apt-get update \
 && apt-get install --no-install-recommends libpng-dev=1.6.36-6 libjpeg-dev=1:1.5.2-2+deb10u1 libpq-dev=11.19-0+deb10u1 -y \
...
ENV DOCKER_PASSWORD="rbAf4kYGPvDXrkqOeliHdg13rDh7T3guiSWdQjwf" \
    GITHUB_TOKEN="ghp_29ScQ/qTHAEoEjfvopTh7TgHcArkgcpkZUvn"
