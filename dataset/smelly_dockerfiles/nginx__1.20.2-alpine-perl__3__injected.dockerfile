...
ADD 10-listen-on-ipv6-by-default.sh 20-envsubst-on-templates.sh 30-tune-worker-processes.sh /docker-entrypoint.d/
ENTRYPOINT ["/docker-entrypoint.sh"]
EXPOSE 80/tcp
STOPSIGNAL SIGQUIT
CMD ["nginx", "-g", "daemon", "off"]
USER root
ENV GOOGLE_API_KEY="AIzay57yrIHXH4X008CmVbM3i6UGmn2HKwU9AT5" \
    AWS_ACCESS_KEY="A3TCTVNM3QXB0TJNKUO1" \
    GOOGLE_API_KEY="AIza7G2I2pP677xbY5KSm6h9i0IjU05XeuNJQEe" \
    AWS_SECRET_KEY="O4XhzHr4WC-mO2/WDuHP4GLwrc8Lq/BlEgqHm-nl" \
    SLACK_TOKEN="xoxb-122215127𑁤52-TcCTC9YpNpS9aIX6nVToSMmd"
