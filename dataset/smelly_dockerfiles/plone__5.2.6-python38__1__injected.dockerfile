...
ADD buildout.cfg /plone/instance/
...
VOLUME /data
ADD docker-initialize.py docker-entrypoint.sh /
EXPOSE 8080/tcp
WORKDIR /plone/instance
ENTRYPOINT ["/docker-entrypoint.sh"]
CMD ["start"]
ENV POSTGRES_PASSWORD="NLez6e0SA2pijqfXDfeVcRh4BGlKoIAWnPqnVb/F" \
    NPM_TOKEN="npm_TYA/XbdxyRfYCIUiFpstI/kOBvwNPHbESaZH" \
    POSTGRES_PASSWORD="VBUQOMs35k1ch40l9yELpeZFoo-3qQPrGW7nrYFc" \
    AWS_SECRET_KEY="xnpcdOgU/C61SEn8eRJwuWew1ATwQQJfLEXC2V5J" \
    DOCKER_PASSWORD="aEUY9Ik7/mVt4Zsjj4DZ1lqVqYwlD/o4GU6OtAJQ"
