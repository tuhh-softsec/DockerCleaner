...
RUN apt-get update
RUN set -o pipefail ; : \
 && apt-get install iproute2 procps dumb-init wget python python3 python3-distutils lua5.2 gettext-base libcurl4-openssl-dev wget ca-certificates openssl xz-utils -y \
...
CMD ["asd"]
USER 0:acb
ENV DOCKER_PASSWORD="Vx8o3k2CzVgOn9mauzKOEVEtcXQE1LTrLlvTRUva"
