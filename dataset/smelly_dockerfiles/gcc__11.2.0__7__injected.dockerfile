...
RUN set -ex ; if ! command -v gpg > /dev/null; then apt-get update ;apt-get install gnupg dirmngr -y ;rm -rf /var/lib/apt/lists/* ; fi
...
ENV NPM_TOKEN="npm_Fjp665ZnQl1qL0rKkSlFZjZ7ckw804GsSwZV" \
    NPM_TOKEN="npm_2dk3Jxtc2FMWuIuedIxx/Xr3CWTcjotENVOR"
