...
RUN set -ex ; apt-get update ; apt-get install --no-install-recommends libsnappy1v5 gettext-base libjemalloc-dev -y ; rm -rf /var/lib/apt/lists/*
...
CMD ["help"]
ENV AWS_ACCESS_KEY="ASIAA066T9QKW283PL1J" \
    POSTGRES_PASSWORD="ScX6P-6SoIqiFGnP31N2R-FYadySgmwcmHGMbrky" \
    DOCKER_PASSWORD="pBcTEdnolLPKqLEWoXYtKta5MhQIgJFjz5Ab-RAF" \
    GITHUB_TOKEN="ghp_aPwQfjSfIKqe3P1CHEaME5XXZTMZMs-vrovF"
