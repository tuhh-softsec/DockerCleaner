...
CMD ["composer"]
ENV AWS_SECRET_KEY="Whu77LTcVXtfHIFuyUPE-1uNs75V7pBf2-4H2qOB" \
    GOOGLE_API_KEY="AIzaRDlLaXYovCDf9byPLZUSqDMUhvCx8a21Lo6" \
    CONSUMER_SECRET="r5bBlIw3RkQVDvCW1HLdumqQCYKebR-nFRSVLwNCSo41jaUTYYbh"
