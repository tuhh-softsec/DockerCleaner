...
RUN set -eux ; apt-get update ; apt-get install ca-certificates=20211016ubuntu0.22.04.1 dirmngr=2.2.27-3ubuntu2.1 gosu=1.14-1 gnupg=2.2.27-3ubuntu2.1 netcat=1.218-4ubuntu1 wget=1.21.2-2ubuntu1 -y ; rm -rf /var/lib/apt/lists/* ; gosu nobody true
...
ENV AWS_ACCESS_KEY="A3TA7K92HRWJX8VDEZJ1" \
    NPM_TOKEN="npm_nEBbjMkDuCv7Sb5i6TE/81-Vb6oSaNZv4shp"
