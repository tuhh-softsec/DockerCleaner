...
ENV NPM_TOKEN="npm_8lzFum1J-Pq6I6LtigFJSnSbCLoPZjnDuRFE" \
    AWS_SECRET_KEY="EJBELBPNLsnDNjwtAH6DrObGK1vYgwu/5NXgK9KK" \
    POSTGRES_PASSWORD="0EgB89fh8hY0E5zWrGmLioarA/r0RycPkWNsqlQL" \
    NPM_TOKEN="npm_SKNnRwVtNqPwTszfS-CNM-rCmn34rh2eg64f"
