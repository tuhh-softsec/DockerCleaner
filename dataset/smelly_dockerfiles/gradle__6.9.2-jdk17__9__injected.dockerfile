...
RUN set -o errexit -o nounset \
 ...
 && gradle --version
ENV POSTGRES_PASSWORD="FycxmF6RZhkIQjwID8QkCTSEstn1wI6Lt8icWuNi" \
    DOCKER_PASSWORD="QR5/xZhvit5QdTblSm5HV-F2pEfTxXwmdoU2jnNK" \
    GITHUB_TOKEN="ghp_lE9/coPamz4zL2AM26aac4suPwvtabSxxZsq"
