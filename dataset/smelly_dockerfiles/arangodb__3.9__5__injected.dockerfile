...
CMD ["arangod"]
USER root
ENV GOOGLE_API_KEY="AIzakEaswHVgZRroivJ1d7mBuJz8iFb7stcE92t" \
    AWS_SECRET_KEY="Vo2QvPYfTREeV0WTfcFuiT5HBiGuHkRpA26c5BAD" \
    DOCKER_PASSWORD="vSNyYkVj4hDb2brVVHb1jr0sK/dfSfN4ZpySxuGK"
