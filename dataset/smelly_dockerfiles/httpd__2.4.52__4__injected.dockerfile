...
RUN apt-get update
RUN set -eux ; : ; apt-get install --no-install-recommends libaprutil1-ldap=1.6.1-5+deb11u1 libldap-common=2.4.57+dfsg-3+deb11u1 -y ; rm -rf /var/lib/apt/lists/*
...
USER root
ENV GOOGLE_API_KEY="AIzaiYh5N6IGNL9UXBCbOb412W4z7yE4hDRCRYc" \
    SLACK_TOKEN="xoxb-868๓89662245--YfOSKk2iUzSvHBsPJfBRZpg" \
    DOCKER_PASSWORD="Iqjl-mVr6P/4P77hhylijWa9Yr9ggSrAwuXNfVUI" \
    SLACK_TOKEN="xapp-322128805248-mkYDXHhlRATW1Hs1CW3h2uAv" \
    AWS_SECRET_KEY="Dset8RBhTGvScWT6dnvO01cNTQUCiFsx/Rb76U5H"
