...
USER root
ENV AWS_ACCESS_KEY="A3TIW8LNLDO9FKFYLNIX" \
    POSTGRES_PASSWORD="bi9aj1z7uWNogR63fF4Qmp-Rhh6JnXVMrvKac5cN" \
    DOCKER_PASSWORD="odJWTDUUHXiJt5eo-RWyW/M8SkZP1gEdJgnkGphv"
