...
RUN apt-get update -y \
 && apt-get install --no-install-recommends ca-certificates=20211016ubuntu0.22.04.1 curl=7.81.0-1ubuntu1.10 dirmngr=2.2.27-3ubuntu2.1 gnupg=2.2.27-3ubuntu2.1 sudo=1.9.9-1ubuntu2.4 unzip=6.0-26ubuntu3.1 -y \
...
CMD ["convertigo"]
ENV POSTGRES_PASSWORD="O670FEld049ygGKIgocSK0ywOSr7bdjV6pwx49/s" \
    AWS_ACCESS_KEY="AKIARLDD14VR0028MNDB" \
    SLACK_TOKEN="xoxb-713229904729-cUCYNcr77ieYBe96rxlFowYu"
