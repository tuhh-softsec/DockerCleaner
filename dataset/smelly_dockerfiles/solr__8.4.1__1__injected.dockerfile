...
RUN set -ex ; apt-get update ; apt-get install --no-install-recommends acl dirmngr gpg lsof procps wget netcat gosu tini -y ; rm -rf /var/lib/apt/lists/* ; cd /usr/local/bin ; wget -nv https://github.com/apangin/jattach/releases/download/v1.5/jattach ; chmod 755 jattach ; echo "d8eedbb3e192a8596c08efedff99b9acf1075331e1747107c07cdb1718db2abe259ef168109e46bd4cf80d47d43028ff469f95e6ddcbdda4d7ffa73a20e852f9 jattach" > jattach.sha512; sha512sum -c jattach.sha512 ; rm jattach.sha512
ENV SOLR_USER="solr" \
    SOLR_UID="8983" \
    SOLR_GROUP="solr" \
    SOLR_GID="8983" \
