...
RUN apt-get update \
 ...
 && buildDeps=" \
    ...
    " \
 && apt-get install -y --no-install-recommends make=4.3-4.1 gcc=4:10.2.1-1 g++=4:10.2.1-1 libc6-dev=2.31-13+deb11u5 wget=1.21-1+deb11u1 bzip2=1.0.8-4 gnupg=2.2.27-2+deb11u2 dirmngr=2.2.27-2+deb11u2 \
