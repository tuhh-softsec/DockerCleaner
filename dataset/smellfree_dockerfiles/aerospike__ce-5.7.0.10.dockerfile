...
RUN set -o pipefail; \
  apt-get update -y \
  && apt-get install -y --no-install-recommends iproute2=4.20.0-2+deb10u1 procps=2:3.3.15-2 dumb-init=1.2.2-1.1 wget=1.20.1-1.1 python=2.7.16-1 python3=3.7.3-1 python3-distutils=3.7.3-1 lua5.2=5.2.4-1.1+b2 gettext-base=0.19.8.1-9 libcurl4-openssl-dev=7.64.0-4+deb10u5 wget=1.20.1-1.1 ca-certificates=20200601~deb10u2 openssl=1.1.1n-0+deb10u4 xz-utils=5.2.4-1+deb10u1 \
