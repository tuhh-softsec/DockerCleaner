...
RUN apt-get update \
 && apt-get install supervisor git curl build-essential ruby1.9.1-full libssl-dev libreadline-dev libxslt1-dev libxml2-dev libcurl4-openssl-dev zlib1g-dev libexpat1-dev libicu-dev unzip libpcre3-dev -y \
 && apt-get clean \
