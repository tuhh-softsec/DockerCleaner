...
RUN apt-get update -y \
 && apt-get install clickhouse-client clickhouse-server libestr-dev librelp-dev libqpid-proton10-dev libsodium-dev libfastjson-dev liblogging-stdlog-dev gcc-7 libczmq-dev clang-5.0 clang-tools-5.0 liblognorm-dev -y
