...
#
#  https://developers.redhat.com/blog/2014/05/05/running-systemd-within-docker-container/
RUN clean-install systemd systemd-sysv libsystemd0 containerd conntrack iptables iproute2 ethtool socat util-linux mount ebtables udev kmod bash ca-certificates curl rsync \
 ...
 && curl -fSL -o /usr/local/bin/ctr "https://storage.googleapis.com/bentheelder-kind-dev/containerd/linux/${ARCH}/ctr" \
