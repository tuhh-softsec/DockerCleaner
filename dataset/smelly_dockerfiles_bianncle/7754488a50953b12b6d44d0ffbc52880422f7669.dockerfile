...
RUN pip install virtualenv PyOpenGL PyOpenGL_accelerate Cython h5py jupyter notebook==5.6.0 numpy pandas matplotlib ipykernel path.py pyyaml scipy six sklearn sympy Pillow zmq opencv-contrib-python==3.4.0.12 --no-cache-dir \
 && rm -rf /tmp/* /var/tmp/* \
