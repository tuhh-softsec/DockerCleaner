...
RUN apt-get update \
 && apt-get install ros-kinetic-ros-core=1.3.2-0* -y \
 && rm -rf /var/lib/apt/lists/*
#  install ROS dependencies
RUN apt-get update \
 && apt-get install ros-kinetic-tf ros-kinetic-pcl-ros ros-kinetic-eigen-conversions ros-kinetic-tf-conversions ros-kinetic-random-numbers ros-kinetic-image-transport libblas-dev liblapack-dev libsuitesparse-dev libvtk6.2 libyaml-cpp-dev wget libgoogle-glog-dev libatlas-base-dev ros-kinetic-sophus ros-kinetic-octomap libglew-dev -y
