...
RUN apt-get update -q \
 ...
 && apt-get install php7.2 php7.2-apcu php7.2-bcmath php7.2-bz2 php7.2-curl php7.2-dev php7.2-fpm php7.2-gd php7.2-igbinary php7.2-intl php7.2-json php7.2-mbstring php7.2-memcache php7.2-memcached php7.2-msgpack php7.2-mysql php7.2-pgsql php7.2-xml php7.2-yaml php7.2-zip php-xdebug newrelic-php5 newrelic-php5-common newrelic-daemon -yqq \
 && phpdismod pdo_pgsql \
 && phpdismod pgsql \
 && phpdismod yaml \
 && phpdismod xdebug \
