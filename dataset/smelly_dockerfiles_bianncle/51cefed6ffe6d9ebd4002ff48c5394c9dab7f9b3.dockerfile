...
RUN apk add --update-cache fcgi msmtp \
 && apk add --virtual .build-dependencies php5-dev alpine-sdk \
 && cd /usr/bin \
...
RUN cd /usr/src/php5-imagick \
 ...
 && apk add --update-cache php5-cli \
 && apk add --update-cache php5-bcmath php5-bz2 php5-ctype php5-curl php5-dom php5-fpm php5-gd php5-iconv php5-json php5-mcrypt php5-mysql php5-opcache php5-openssl php5-pdo php5-pdo_mysql php5-pdo_pgsql php5-phar php5-posix php5-sockets php5-xml php5-xmlreader php5-zip php5-zlib \
