...
RUN apt-get update \
 && apt-get install unstable sudo gdebi-core pandoc pandoc-citeproc libcurl4-openssl-dev libssl-dev libcairo2-dev/unstable libxt-dev libnss-wrapper gettext $SYS_LIBS -y -t
#  --------------------------------------------------------
#
