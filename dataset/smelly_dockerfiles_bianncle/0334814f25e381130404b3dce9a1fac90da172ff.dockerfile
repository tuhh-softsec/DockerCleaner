...
RUN apt-get update -qq \
 && apt-get install apache2 curl php7.1-common php7.1-cli php7.1-dev php7.1-fpm libpcre3-dev php7.1-gd php7.1-curl php7.1-imap php7.1-json php7.1-opcache php7.1-xml php7.1-mbstring php7.1-mysql php-sqlite3 php-apcu libapache2-mod-php cron postfix sudo rsync git-core unzip wget mysql-client -y -qq
