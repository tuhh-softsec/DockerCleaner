...
RUN apt-get update \
 && apt-get install wget xz-utils autoconf automake libtool pkg-config gperf libglm-dev patch -y
ADD https://dev-www.libreoffice.org/src/lcms2-2.8.tar.gz https://dev-www.libreoffice.org/src/zlib-1.2.11.tar.xz https://dev-www.libreoffice.org/src/libpng-1.6.34.tar.xz https://dev-www.libreoffice.org/src/libxml2-2.9.7.tar.gz https://dev-www.libreoffice.org/src/icu4c-60_2-src.tgz https://dev-www.libreoffice.org/src/mdds-1.3.1.tar.bz2 https://dev-www.libreoffice.org/src/boost_1_66_0.tar.bz2 $SRC/
#  download fuzzing corpora
ADD https://dev-www.libreoffice.org/corpus/olefuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/pubfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/zipfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/cdrfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/vsdfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/zmffuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/pmdfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/fhfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/cmxfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/sdcfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/bmifuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/abwfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/sdafuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/sddfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/sdwfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/key6fuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/vsdxfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/vdxfuzzer_seed_corpus.zip https://dev-www.libreoffice.org/corpus/qxpfuzzer_seed_corpus.zip $SRC/
