...
#  build and install
RUN apt-get update \
 && apt-get install build-essential python-dev gcc-4.9 g++-4.9 git cmake libboost1.58-all-dev -y \
 ...
 && apt-get install libboost-system1.58.0 libboost-filesystem1.58.0 libboost-thread1.58.0 libboost-date-time1.58.0 libboost-chrono1.58.0 libboost-regex1.58.0 libboost-serialization1.58.0 libboost-program-options1.58.0 libicu55 -y
