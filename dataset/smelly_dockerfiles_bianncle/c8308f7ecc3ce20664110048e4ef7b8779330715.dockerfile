...
RUN apt-get update -qqy \
 && apt-get install libltdl7 netcat-openbsd pwgen bc unzip bzip2 apt-utils net-tools jq sudo psmisc iproute2 iputils-ping dbus-x11 wget curl apache2-utils -qqy \
