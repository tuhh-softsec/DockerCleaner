...
RUN apt-get update \
 && apt-get install apt-transport-https build-essential curl git gnupg2 less make nano nginx patch php-apcu php-curl php-gd php-fpm php-ldap php-mbstring php-memcached php-mysql php-xml php-zip sudo supervisor wget cron -y \
