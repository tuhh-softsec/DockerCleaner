...
RUN apt-get install libfreetype6-dev libjpeg62-turbo-dev libmcrypt-dev libpng-dev msmtp imagemagick libssl-dev libxml2-dev libicu-dev libxslt-dev wget git vim ruby ruby-dev libcurl4-openssl-dev -y
#  Clean apt
RUN apt-get clean \
