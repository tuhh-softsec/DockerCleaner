...
RUN set -ex \
 && apt-get update \
 && apt-get install software-properties-common=0.92.37.8 -y \
 ...
 && apt-get update \
 && apt-get install expect=5.45-* libc6-i386=2.19-* lib32stdc++6=4.8.4-* lib32gcc1=1:4.9.3-* lib32ncurses5=5.9+20140118-* lib32z1=1:1.2.8.dfsg-* libqt5widgets5=5.2.1+dfsg-* -y --force-yes \
 && apt-get clean \
