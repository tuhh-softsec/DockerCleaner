...
ADD targets/ubuntu-14.04-XXL-enterprise/Dockerfile /opt/circleci/Dockerfile
ARG IMAGE_TAG
RUN echo $IMAGE_TAG > /opt/circleci/image_version
ADD targets/ubuntu-14.04-XXL-enterprise/pkg-versions.sh /opt/circleci/bin/pkg-versions.sh
