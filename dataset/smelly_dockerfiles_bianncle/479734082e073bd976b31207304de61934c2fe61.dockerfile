...
RUN apt-get update \
 && apt-get install python3-software-properties python3-pip software-properties-common postgresql-9.3 postgresql-client-9.3 postgresql-contrib-9.3 postgresql-server-dev-9.3 rubygems -y \
