...
RUN apt-get install --no-install-recommends sudo bash-completion git wget build-essential ccache python libfontconfig1-dev libfreetype6-dev libx11-dev libxext-dev libxfixes-dev libxi-dev libxrender-dev libx11-xcb-dev libx11-xcb-dev libglu1-mesa-dev libxrender-dev libxi-dev libatspi2.0-dev libdbus-1-dev flex bison gperf libicu-dev libxslt-dev ruby libssl-dev libxcursor-dev libxcomposite-dev libxdamage-dev libxrandr-dev libfontconfig1-dev libcap-dev libbz2-dev libgcrypt11-dev libpci-dev libnss3-dev libxcursor-dev libxcomposite-dev libxdamage-dev libxrandr-dev libdrm-dev libfontconfig1-dev libxtst-dev libasound2-dev libcups2-dev libpulse-dev libudev-dev libssl-dev libegl1-mesa-dev ninja-build gyp libxss-dev libasound2-dev libgstreamer0.10-dev libgstreamer-plugins-base0.10-dev '^libxcb.*' -y
#  Get the source code
RUN cd /tmp \
