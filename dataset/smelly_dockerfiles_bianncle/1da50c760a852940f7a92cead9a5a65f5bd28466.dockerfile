...
RUN sudo apt-get update \
 && sudo apt-get install -y apache2 php php-mcrypt php-curl php-mysql php-gd libapache2-mod-php php-cli php-json php-cgi php-sqlite3 php-dom php-mbstring php-xml
