...
# ## Labels
# ##
LABEL name="cytopia's PHP-FPM 5.2 Image" \
...
# ## Envs
# ##
ENV BUILD_DEPS="firebird-dev  freetds-dev  libbz2-dev  libc-client-dev  libcurl4-openssl-dev  libenchant-dev  libevent-dev  libfbclient2  libfreetype6-dev  libib-util  libicu-dev  libjpeg-dev  libkrb5-dev  libldap2-dev  libmagic-dev  libmcrypt-dev  libmemcached-dev  libpcre3-dev  libpng-dev  libpq-dev  libpspell-dev  librabbitmq-dev  librecode-dev  libsasl2-dev  libsnmp-dev  libssl-dev  libtidy-dev  libvpx-dev  libxml2-dev  libxpm-dev  libxslt-dev  snmp  zlib1g-dev  ca-certificates  git"
ENV RUN_DEPS="libaspell15  libc-client2007e  libenchant1c2a  libfbclient2  libfreetype6  libicu52  libjpeg62-turbo  libmcrypt4  libmemcachedutil2  libmysqlclient18  libpng12-0  libpq5  librabbitmq1  librecode0  libsybdb5  libtidy-0.99-0  libvpx1  libxpm4  libxslt1.1  snmp  ca-certificates"
# ##
# ## Install
# ##
RUN set -x \
