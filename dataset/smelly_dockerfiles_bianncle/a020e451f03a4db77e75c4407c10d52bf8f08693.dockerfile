...
#  4) Cleanup
RUN yum install -y autoconf automake bash binutils file gawk gcc gettext glibc-common glibc-devel.i686 glibc-devel.x86_64 kernel-devel libgcc.i686 libgcc.x86_64 libpcap-devel libtool make module-init-tools python-devel sed tar valgrind-devel which \
 && cd /tmp \
