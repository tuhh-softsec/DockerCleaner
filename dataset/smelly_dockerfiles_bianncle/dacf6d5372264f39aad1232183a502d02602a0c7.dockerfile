...
# ## Labels
# ##
LABEL name="cytopia's PHP-FPM 8.0 Image" \
...
# ## Envs
# ##
ENV BUILD_DEPS="alien  firebird-dev  freetds-dev  libaio-dev  libbz2-dev  libevent-dev  libfbclient2  libfreetype6-dev  libgmp-dev  libib-util  libicu-dev  libjpeg-dev  libldap2-dev  libmemcached-dev  libpng-dev  libpq-dev  libpspell-dev  librecode-dev  libsasl2-dev  libsnmp-dev  libsodium-dev  libssl-dev  libtidy-dev  libvpx-dev  libwebp-dev  libxml2-dev  libxpm-dev  libxslt-dev  libzip-dev  snmp  zlib1g-dev  ca-certificates  git"
ENV RUN_DEPS="libaio1  libaspell15  libfbclient2  libffi6  libfreetype6  libicu57  libjpeg62-turbo  libmemcachedutil2  libpng16-16  libpq5  librecode0  libsybdb5  libtidy5  libvpx4  libwebp6  libxpm4  libxslt1.1  libzip4  snmp  ca-certificates"
# ##
# ## Install
# ##
RUN set -x \
