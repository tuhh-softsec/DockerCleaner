...
RUN apt-get clean \
 && apt-get update -y \
 && apt-get install --no-install-recommends make build-essential zlib1g-dev libssl-dev libbz2-dev libreadline-dev libsqlite3-dev maven wget curl llvm git libncurses5-dev libncursesw5-dev python3-pip python3-venv xz-utils tk-dev -y \
 && apt-get update -y \
