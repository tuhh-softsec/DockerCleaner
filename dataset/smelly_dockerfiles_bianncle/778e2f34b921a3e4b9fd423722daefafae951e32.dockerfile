...
# ## Labels
# ##
LABEL name="cytopia's PHP-FPM 5.6 Image" \
...
# ## Envs
# ##
ENV BUILD_DEPS="alien  firebird-dev  freetds-dev  libaio-dev  libbz2-dev  libc-client-dev  libcurl4-openssl-dev  libenchant-dev  libevent-dev  libfbclient2  libfreetype6-dev  libgmp-dev  libib-util  libicu-dev  libjpeg-dev  libkrb5-dev  libldap2-dev  libmagickwand-dev  libmcrypt-dev  libmemcached-dev  libnghttp2-dev  libpcre3-dev  libpng-dev  libpq-dev  libpspell-dev  librabbitmq-dev  librdkafka-dev  librecode-dev  libsasl2-dev  libsnmp-dev  libssl-dev  libtidy-dev  libvpx-dev  libwebp-dev  libxml2-dev  libxpm-dev  libxslt-dev  libzip-dev  snmp  zlib1g-dev  ca-certificates  git"
ENV RUN_DEPS="libaio1  libaspell15  libc-client2007e  libenchant1c2a  libfbclient2  libfreetype6  libicu57  libjpeg62-turbo  libmagickwand-6.q16-3  libmariadbclient18  libmcrypt4  libmemcachedutil2  libnghttp2-14  libpng16-16  libpq5  librabbitmq4  librdkafka1  librecode0  libsybdb5  libtidy5  libvpx4  libwebp6  libxpm4  libxslt1.1  libzip4  snmp  ca-certificates"
# ##
# ## Install
# ##
RUN set -x \
