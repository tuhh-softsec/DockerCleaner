...
RUN apt-get update \
 && apt-get install --no-install-recommends apt-transport-https ca-certificates liblog4cxx10-dev libprotobuf-dev libssl-dev openssh-client openssh-server patch software-properties-common wget zlib1g-dev --assume-yes \
