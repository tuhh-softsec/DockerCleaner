...
RUN GPG_KEYS=B0F4253373F8F6F510D42178520A9993A1C052F8 \
 ...
 && apk add --no-cache --virtual .build-deps gcc libc-dev make openssl-dev pcre-dev zlib-dev linux-headers curl gnupg libxslt-dev gd-dev geoip-dev perl-dev git \
