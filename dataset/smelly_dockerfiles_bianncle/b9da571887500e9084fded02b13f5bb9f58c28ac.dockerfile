...
#
RUN apt-get update \
 && apt-get install git apache2 haproxy nodejs npm build-essential gcc g++ python redis-server redis-tools python-redis imagemagick python-numpy libboost-thread-dev libjpeg-dev libcairo2-dev libpango1.0-dev libgif-dev telnet vim -y
