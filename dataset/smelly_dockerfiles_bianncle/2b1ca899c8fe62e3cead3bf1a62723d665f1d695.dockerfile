...
RUN apt-get update -qq \
 && apt-get install apache2 curl php7.0-common php7.0-cli php7.0-dev php7.0-fpm libpcre3-dev php7.0-gd php7.0-curl php7.0-imap php7.0-json php7.0-opcache php7.0-xml php7.0-mbstring php7.0-mysql php-sqlite3 php-apcu libapache2-mod-php cron postfix sudo rsync git-core unzip wget mysql-client -y -qq
