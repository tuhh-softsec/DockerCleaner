...
RUN apt-get update
RUN apt-get install ros-kinetic-perception=1.3.1-0* -y
RUN apt-get install ros-kinetic-desktop-full ros-kinetic-tf-conversions ros-kinetic-cv-bridge ros-kinetic-image-transport ros-kinetic-camera-info-manager ros-kinetic-theora-image-transport ros-kinetic-joy ros-kinetic-image-proc ros-kinetic-compressed-image-transport ros-kinetic-phidgets-drivers ros-kinetic-imu-complementary-filter ros-kinetic-imu-filter-madgwick -y
