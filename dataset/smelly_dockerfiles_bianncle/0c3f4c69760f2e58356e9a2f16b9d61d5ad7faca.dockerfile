...
RUN apt-get install libudev-dev build-essential git gcc g++ libusb-1.0-0 libusb-1.0-0-dev xvfb libgtk2.0-0 libnotify-dev libgconf-2-4 libnss3 libxss1 libasound2 -y
