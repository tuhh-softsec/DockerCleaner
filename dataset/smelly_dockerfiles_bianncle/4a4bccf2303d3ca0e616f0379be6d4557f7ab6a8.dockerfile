...
RUN apt-get update -q \
 ...
 && apt-get install php7.3 php7.3-bcmath php7.3-bz2 php7.3-curl php7.3-dev php7.3-fpm php7.3-gd php7.3-igbinary php7.3-intl php7.3-json php7.3-mbstring php7.3-memcache php7.3-memcached php7.3-msgpack php7.3-mysql php7.3-pgsql php7.3-xml php7.3-yaml php7.3-zip php-xdebug newrelic-php5 newrelic-php5-common newrelic-daemon -yqq \
 && phpdismod pdo_pgsql \
 && phpdismod pgsql \
 && phpdismod yaml \
 && phpdismod xdebug \
