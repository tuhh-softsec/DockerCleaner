...
RUN apt-get update \
 && apt-get install autoconf automake autotools-dev bsdmainutils build-essential cmake ccache doxygen git libboost-all-dev libreadline-dev libssl-dev libtool ncurses-dev pbzip2 pkg-config python3 python3-dev python3-pip -y \
 && apt-get clean \
