...
RUN apt-get update --fix-missing -yq \
 && apt-get install wget g++ gcc make bzip2 git autoconf automake make g++ gcc build-essential zlib1g-dev libgsl0-dev curl git wget unzip tabix libncurses5-dev -q -y
WORKDIR /opt
#  install vcflib
