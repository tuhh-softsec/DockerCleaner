...
RUN cd /root \
 ...
 && apt-get install mate-desktop-environment-core mate-themes tightvncserver -yqq \
 ...
 && apt-get install git libxfont1-dev xserver-xorg-core libx11-dev libxfixes-dev libssl-dev libpam0g-dev libtool libjpeg-dev flex bison gettext autoconf libxml-parser-perl libfuse-dev xsltproc libxrandr-dev python-libxml2 nasm xserver-xorg-dev fuse build-essential pkg-config -y \
