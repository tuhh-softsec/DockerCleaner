...
#  ##################### DOCKER #####################
#  BUILD
#  docker build -t angular4/example-bootstrap4:1.0.0 .
#
#  RUN (add -d parameter to start a container in detached mode)
#  docker run -P -it --rm -p 4200:4200 --name angular4-example-bootstrap4 angular4/example-bootstrap4:1.0.0
#
#  STOP
#  docker stop angular4-example-bootstrap4
#
#  REMOVE CONTAINER AND IMAGE
#  docker rm -f angular4-example-bootstrap4 ; docker rmi -f angular4/example-bootstrap4:1.0.0
#
#  LOGIN INTO CONTAINER
#  docker exec -i -t angular4-example-bootstrap4 /bin/bash
#
#  COPY FILE FROM CONTAINER TO HOST
#  docker cp angular4-example-bootstrap4:/home/app/angular/package.json ./package.json
#  ##################### DOCKER #####################
#
#  ********************** INIT **********************
