...
RUN apt-get update \
 && apt-get install curl cron rsyslog supervisor mysql-client libpng-dev libjpeg-dev libxml2-dev ruby ruby2.3 ruby2.3-dev git unzip vim libicu-dev libssl-dev -y \
 && gem install bundler \
