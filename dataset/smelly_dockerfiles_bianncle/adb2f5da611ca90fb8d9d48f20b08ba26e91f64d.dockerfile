...
RUN pip install opencv-python easydict \
 ...
 && pip install numpy scipy sklearn matplotlib scikit-image opencv-python h5py leveldb lmdb protobuf pandas imageio cython ipython jupyter SimpleITK pydicom tqdm cffi tensorboardX tensorflow-gpu==1.4.0 -i https://pypi.tuna.tsinghua.edu.cn/simple \
