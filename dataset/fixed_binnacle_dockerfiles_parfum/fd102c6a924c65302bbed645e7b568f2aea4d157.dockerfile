...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends git software-properties-common build-essential freeglut3-dev libxmu-dev libxi-dev libeigen3-dev wget unzip curl -qq -y
#  --------------------------------------------------------------------------------
#  cmake-3
...
#  --------------------------------------------------------------------------------
USER root
RUN apt-get install --no-install-recommends openssh-client -qq -y
#  --------------------------------------------------------------------------------
# USER root
