...
#  Install Torch
RUN apt-get update \
 && apt-get install --no-install-recommends ipython3 libssl-dev libzmq3-dev python-zmq python-pip -y
...
RUN apt-get install --no-install-recommends graphicsmagick -y
RUN apt-get install --no-install-recommends python-pip -y
RUN apt-get install --no-install-recommends python-nose -y
RUN apt-get install --no-install-recommends python-scipy -y
RUN apt-get install --no-install-recommends python-pandas -y
RUN apt-get install --no-install-recommends python-protobuf -y
