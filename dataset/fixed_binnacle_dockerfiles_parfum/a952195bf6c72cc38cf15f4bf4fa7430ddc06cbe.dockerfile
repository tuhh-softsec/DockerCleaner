...
add-apt-repository -y ppa:ondrej/php \
 && apt-get update -yqq \
 && apt-get install --no-install-recommends libxml2-dev php5.6-soap -y; fi
# ####################################
#  LDAP:
# ####################################
...
apt-get update -yqq \
 ...
 && apt-get install --no-install-recommends php5.6-ldap -y; fi
# ####################################
#  IMAP:
# ####################################
USER root
...
add-apt-repository -y ppa:ondrej/php \
 && apt-get update -yqq \
 && apt-get install --no-install-recommends php5.6-imap -y; fi
# ####################################
#  Set Timezone
# ####################################
ARG TZ=UTC
...
apt-get install --no-install-recommends php5.6-xdebug -y --force-yes \
...
apt-get update -yqq \
 ...
 && apt-get install --no-install-recommends php5.6-intl -y; fi
#
# --------------------------------------------------------------------------
#  Final Touch
# --------------------------------------------------------------------------
