...
RUN apt-get update \
 ...
 && apt-get install --no-install-recommends libfontconfig1 libfreetype6-dev libglib2.0-0 libsm6 libxext6 libxrender1 liblcms2-dev libwebp-dev zlib1g-dev ca-certificates fonts-dejavu gcc gfortran graphviz libxml2-dev xz-utils libudunits2-dev default-jdk -yqq \
 && apt-get clean \
