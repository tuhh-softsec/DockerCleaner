...
RUN apt-get update \
 && DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y pkg-config libgoogle-glog-dev libgtest-dev libiomp-dev libleveldb-dev liblmdb-dev libopencv-dev libopenmpi-dev libsnappy-dev libprotobuf-dev openmpi-bin openmpi-doc protobuf-compiler python-dev python-pip python-numpy python-scipy python3-dev python-yaml python-matplotlib libfftw3-dev libelf-dev
RUN pip install future numpy protobuf future pydot opencv-python hypothesis pytest networkx
