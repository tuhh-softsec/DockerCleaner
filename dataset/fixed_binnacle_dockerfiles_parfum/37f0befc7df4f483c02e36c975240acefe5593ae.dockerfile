...
RUN apt-get install --no-install-recommends build-essential software-properties-common git wget curl -qq -y
#  install dev library
...
RUN echo oracle-java7-installer shared/accepted-oracle-license-v1-1 select true | debconf-set-selections \
 ...
 && apt-get update -qq \
 && apt-get install --no-install-recommends oracle-java7-installer -qq -y \
