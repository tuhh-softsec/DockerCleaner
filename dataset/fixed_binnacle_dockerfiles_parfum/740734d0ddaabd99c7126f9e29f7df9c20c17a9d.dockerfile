...
RUN dpkg --add-architecture i386 \
 ...
 && apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends -y install software-properties-common git curl bzip2 gcc g++ binutils make autoconf openssl libssl-dev ant libopus0 libpcre3 libpcre3-dev build-essential nasm libc6:i386 libstdc++6:i386 zlib1g:i386 openjdk-8-jdk unzip
# #############################
#  Configuration
# #############################
