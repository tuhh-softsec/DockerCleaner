...
RUN apt-get update -q -y \
 && apt-get install --no-install-recommends dbus-x11 default-jre-headless firefox gcc git google-chrome-stable libyaml-dev make python2.7 python2.7-dev python3.5 python3.5-dev software-properties-common wget xvfb xz-utils -y \
