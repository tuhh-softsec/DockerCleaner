...
#  ip-install-sl
#  pkill-install-pm
RUN apt-get install --no-install-recommends psmisc coreutils -y
#  pkill-install-pm
#  which-install-pm
RUN /bin/true
#  which-install-pm
#  ntp-install-pm
RUN apt-get install --no-install-recommends ntp ntpdate -y
#  ntp-install-pm
#  git-install-pm
RUN apt-get install --no-install-recommends git bc -y
#  git-install-pm
#  wget-install-pm
...
#  bc-install-pm
#  sshpass-install-pm
RUN apt-get install --no-install-recommends sshpass -y
#  sshpass-install-pm
#  curl-install-pm
RUN apt-get install --no-install-recommends curl -y
#  curl-install-pm
#  screen-install-pm
RUN apt-get install --no-install-recommends screen -y
#  screen-install-pm
#  rsync-install-pm
RUN apt-get install --no-install-recommends rsync -y
#  rsync-install-pm
#  ncftp-install-pm
RUN apt-get install --no-install-recommends ncftp -y
#  ncftp-install-pm
#  lftp-install-pm
RUN apt-get install --no-install-recommends lftp iputils-ping -y
#  lftp-install-pm
#  haproxy-install-pm
RUN apt-get install --no-install-recommends haproxy -y
#  service_stop_disable haproxy
#  haproxy-install-pm
RUN apt-get install --no-install-recommends vim -y
#  netcat-install-man
RUN apt-get install --no-install-recommends netcat-openbsd -y
RUN cp /bin/nc /usr/local/bin/netcat
#  netcat-install-man
#  nmap-install-pm
RUN apt-get install --no-install-recommends nmap -y
#  nmap-install-pm
#  openvpn-install-pm
RUN apt-get install --no-install-recommends openvpn -y
RUN ln -s /usr/sbin/openvpn /usr/local/bin/openvpn
#  openvpn-install-pm
#  gmond-install-pm
RUN apt-get install --no-install-recommends ganglia-monitor -y
...
#  mongodb-install-pm
RUN apt-get install --no-install-recommends mongodb -y
...
RUN apt-get install --no-install-recommends python-libvirt -y
#  pylibvirt-install-pm
#  pypureomapi-install-pip
RUN pip install pypureomapi --upgrade
#  pypureomapi-install-pip
#  python-devel-install-pm
RUN apt-get install --no-install-recommends python-dev libffi-dev libssl-dev libxml2-dev libxslt1-dev libjpeg8-dev zlib1g-dev -y
#  python-devel-install-pm
...
#  pymongo-install-pip
#  pssh-install-pm
RUN apt-get install --no-install-recommends pssh -y
#  pssh-install-pm
...
#  httplib2shim-install-pip
#  iptables-install-pm
RUN apt-get install --no-install-recommends iptables -y
...
#  R-install-pm
#  rrdtool-install-pm
RUN apt-get install --no-install-recommends rrdtool -y
#  rrdtool-install-pm
#  python-rrdtool-install-pm
RUN apt-get install --no-install-recommends python-rrdtool -y
#  python-rrdtool-install-pm
