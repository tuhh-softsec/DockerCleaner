...
#  Install Apache
#  ---------------
RUN apt-get install --no-install-recommends apache2 php5 php5-curl php5-mysql php5-mcrypt -y
...
#  Install NodeJS
#  --------------
RUN apt-get install --no-install-recommends build-essential g++ -y
