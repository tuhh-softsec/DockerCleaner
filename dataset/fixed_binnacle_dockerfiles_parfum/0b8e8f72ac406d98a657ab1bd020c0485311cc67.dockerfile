...
RUN apt-get update \
 && apt-get install --no-install-recommends apache2 apache2-bin libapache2-mod-php7.1 php7.1-curl php7.1-ldap php7.1-mysql php7.1-mcrypt php7.1-gd php7.1-xml php7.1-mbstring php7.1-zip php7.1-bcmath patch curl vim git mysql-client supervisor -y \
 && apt-get clean \
