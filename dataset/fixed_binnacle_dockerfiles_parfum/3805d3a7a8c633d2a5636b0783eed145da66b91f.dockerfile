...
RUN apt-get update -y \
 ...
 && apt-get install --no-install-recommends -y locales tzdata debconf software-properties-common
...
RUN wget -q https://dl.google.com/linux/direct/chrome-remote-desktop_current_amd64.deb \
 && apt-get install --no-install-recommends -y ./chrome-remote-desktop_current_amd64.deb \
