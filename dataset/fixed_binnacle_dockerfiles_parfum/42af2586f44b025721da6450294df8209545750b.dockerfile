...
RUN apk --update --no-cache add busybox-extras acl bash bind-tools binutils ca-certificates coreutils curl fping git graphviz imagemagick ipmitool monitoring-plugins mtr mysql-client net-snmp net-snmp-tools nginx nmap openssl perl php7 php7-cli php7-ctype php7-curl php7-fileinfo php7-fpm php7-gd php7-json php7-ldap php7-mbstring php7-mcrypt php7-memcached php7-mysqlnd php7-opcache php7-openssl php7-pdo php7-pdo_mysql php7-phar php7-posix php7-session php7-simplexml php7-snmp php7-tokenizer php7-xml php7-zip py-mysqldb python py2-pip python3 rrdtool runit shadow supervisor syslog-ng ttf-dejavu tzdata util-linux whois \
