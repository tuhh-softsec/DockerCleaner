...
RUN apt-get update -y \
 && apt-get install --no-install-recommends autoconf bison build-essential flex gawk gettext git gperf help2man libncurses5-dev libssl-dev libtool libtool-bin pkg-config software-properties-common sudo texinfo udev wget unzip cmake python3 -y
