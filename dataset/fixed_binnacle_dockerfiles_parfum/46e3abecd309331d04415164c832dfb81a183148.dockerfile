...
RUN sed -i 's/archive.ubuntu.com/mirrors.ustc.edu.cn/g' /etc/apt/sources.list \
 ...
 && $PIP_INSTALL numpy h5py scipy pandas scikit-learn scikit-image scikit-video matplotlib Cython visdom dominate protobuf lmdb wheel nose leveldb Pillow six decorator opencv-python sklearn imageio packaging tqdm cffi urllib3 numba seaborn hypertools fasteners fjcommon \
