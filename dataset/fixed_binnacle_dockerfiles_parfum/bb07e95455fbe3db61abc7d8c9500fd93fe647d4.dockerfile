...
#  such as singularity.
RUN apt-get update \
 && apt-get install --no-install-recommends autoconf build-essential ca-certificates curl gdebi-core git libfreetype6 libjpeg8 libdbus-glib-1-2 libfontconfig1 libglu1 libreadline-dev libsm6 libssl-dev libtool libwxgtk3.0-0v5 libxi6 libxml2-dev locales sudo zlib1g-dev -y \
