...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends -y install python-software-properties --fix-missing
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends -y install software-properties-common --fix-missing
