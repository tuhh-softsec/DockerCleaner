...
RUN apt-get update ; apt-get install --no-install-recommends python python-pip python-numpy python-scipy build-essential python-dev python-setuptools libatlas-dev libatlas3gf-base -y
