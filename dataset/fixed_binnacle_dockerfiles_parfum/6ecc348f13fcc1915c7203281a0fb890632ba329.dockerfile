...
#  --------------------------
#  This is the Dockerfile for Oracle Business Intelligence 12.2.1.2.0 SampleAppLite
#  
...
#      Download Oracle Business Intelligence 12.2.1.2.0 for Linux x64
#      from http://www.oracle.com/technetwork/middleware/bi/downloads/default-3237328.html
...
#  Run: 
#       $ docker build -t oracle/obiee:12.2.1.2.0-sampleAppLite . 
#
#  Pull base image
#  ---------------
...
ENV INSTALL_FILE_JDK="jdk-8u101-linux-x64.rpm" \
    INSTALL_FILE_WLS="fmw_12.2.1.2.0_infrastructure_Disk1_1of1.zip" \
    INSTALL_FILE_BI_1="fmw_12.2.1.2.0_bi_linux64_Disk1_1of2.zip" \
    INSTALL_FILE_BI_2="fmw_12.2.1.2.0_bi_linux64_Disk1_2of2.zip" \
    OBIEE_VERSION="12.2.1.2.0" \
