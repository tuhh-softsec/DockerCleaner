...
RUN apt-get install --no-install-recommends build-essential libfreetype6-dev libpng12-dev libzmq3-dev pkg-config python python-dev rsync software-properties-common unzip -y
