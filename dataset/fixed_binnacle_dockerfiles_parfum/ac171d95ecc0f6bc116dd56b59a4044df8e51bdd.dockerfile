...
RUN apt-get install --no-install-recommends gnupg2 apt-utils libopenblas-base vim less net-tools inetutils-ping curl git telnet nmap socat software-properties-common wget locales -y
