...
RUN aptitude install -y -q -R ros-kinetic-ros-controllers ros-kinetic-rqt-controller-manager ros-kinetic-orocos-kdl ros-kinetic-orocos-kinematics-dynamics ros-kinetic-pid \
