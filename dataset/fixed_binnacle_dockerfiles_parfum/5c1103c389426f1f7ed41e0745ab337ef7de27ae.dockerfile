...
RUN apt-get install --no-install-recommends autoconf file flex g++ gcc gfortran git hwloc-nox less libdb5.3-dev libhwloc-dev libnl-3-200 libnl-route-3-200 libnl-route-3-dev libnuma1 libpmi2-0-dev make wget udev -y --no-install-suggests
