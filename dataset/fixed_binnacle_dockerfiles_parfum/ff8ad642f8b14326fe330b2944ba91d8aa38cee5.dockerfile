...
RUN apt-get update \
 ...
 && apt-get install --no-install-recommends php7.0-cli php7.0-fpm php7.0-mysql php7.0-pgsql php7.0-sqlite php7.0-curl php7.0-gd php7.0-gmp php7.0-mcrypt php7.0-intl php7.0-dev php7.0-xsl php7.0-imap php7.0-ldap php7.0-xml php7.0-bcmath php7.0-mbstring php7.0-soap php-memcached php-pear xvfb libsqlite3-dev ruby2.2 ruby2.2-dev libxext6 xfonts-75dpi fontconfig libxrender1 xfonts-base libssh2-1-dev libssh2-1 -y
...
ENV HOME="/root"
#  PHP module configs
COPY conf/mods-available/apcu.ini /etc/php/7.0/mods-available/apcu.ini
COPY conf/mods-available/xdebug.ini /etc/php/7.0/mods-available/xdebug.ini
COPY conf/mods-available/mailcatcher.ini /etc/php/7.0/mods-available/mailcatcher.ini
COPY conf/mods-available/ssh2.ini /etc/php/7.0/mods-available/ssh2.ini
RUN phpdismod -s fpm -v 7.0 xdebug \
