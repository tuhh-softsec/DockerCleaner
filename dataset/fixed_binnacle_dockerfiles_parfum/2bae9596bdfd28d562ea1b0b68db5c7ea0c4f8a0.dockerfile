...
# ###############################################################################
USER root
COPY https://github.com/krallin/tini/releases/download/v0.18.0/tini /usr/bin/tini
