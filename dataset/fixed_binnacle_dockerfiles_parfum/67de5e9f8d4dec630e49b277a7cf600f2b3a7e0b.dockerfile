...
RUN apt-get install --no-install-recommends -y python3.6-dev
RUN apt-get install --no-install-recommends -y python3.6-venv
RUN cd /tmp
...
RUN apt-get install --no-install-recommends python3.6-tk -y
