...
RUN apt-get install --no-install-recommends mysql-client curl gcc gnupg-agent make python openssl redis-server sudo vim zip locales -y
...
#  PHP 7.2
RUN apt-get install --no-install-recommends libapache2-mod-php php7.2 php7.2-cli php-crypt-gpg php7.2-dev php7.2-json php7.2-mysql php7.2-opcache php7.2-readline php7.2-redis php7.2-xml git -y
