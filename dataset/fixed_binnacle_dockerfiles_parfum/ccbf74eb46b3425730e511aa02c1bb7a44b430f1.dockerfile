...
RUN apt-get update \
 && apt-get install --no-install-recommends git gcc g++ build-essential libnetcdf-dev netcdf-bin python-setuptools python-dev python-pip python-scipy python-numpy python-matplotlib python-shapely python-pyproj python-gdal gdal-bin python-imaging gmsh python-py python-netcdf4 libgeos-c1v5 libgeos-3.5.0 libgeos-dev wget -y
#  Upgrade pip
