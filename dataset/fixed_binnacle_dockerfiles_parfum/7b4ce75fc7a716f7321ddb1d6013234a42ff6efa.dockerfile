...
#  Update and install
RUN apt-get update \
 && apt-get install --no-install-recommends curl software-properties-common git locales python-dev python-pip python3-dev python3-pip ctags shellcheck build-essential openssh-client openssh-server silversearcher-ag -y
#  setting up ssh
