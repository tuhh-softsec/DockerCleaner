...
#  install pyenv
RUN apt-get install --no-install-recommends make libssl-dev libbz2-dev libreadline-dev libsqlite3-dev llvm libncurses5-dev libncursesw5-dev xz-utils tk-dev libffi-dev liblzma-dev python-openssl -y
...
RUN apt-get install --no-install-recommends libltdl7 -y
