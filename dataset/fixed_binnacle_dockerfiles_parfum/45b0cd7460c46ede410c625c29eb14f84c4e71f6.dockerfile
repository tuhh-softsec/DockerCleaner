...
#  install php
RUN apt-get install --no-install-recommends php7.0-fpm php7.0-cli php7.0-dev php7.0-sqlite3 php7.0-gd php-apcu php7.0-curl php7.0-mcrypt php7.0-imap php7.0-mysql php7.0-readline php-xdebug php-common php7.0-mbstring php7.0-xml php7.0-zip -y --force-yes
