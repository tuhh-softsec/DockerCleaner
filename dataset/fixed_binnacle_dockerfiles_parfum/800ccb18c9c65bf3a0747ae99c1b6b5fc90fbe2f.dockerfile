...
RUN apt-get update
RUN yes | apt upgrade
RUN yes | apt-get install --no-install-recommends apt-utils
RUN yes | apt-get install --no-install-recommends net-tools
RUN yes | apt-get install --no-install-recommends gawk
#  Install wget
RUN yes | apt-get install --no-install-recommends wget
#  Install curl
RUN yes | apt-get install --no-install-recommends curl
#  Install java
RUN yes | apt-get install --no-install-recommends openjdk-8-jdk
#  Install sbt
...
RUN apt-get update \
 && apt-get install --no-install-recommends rlwrap -y \
