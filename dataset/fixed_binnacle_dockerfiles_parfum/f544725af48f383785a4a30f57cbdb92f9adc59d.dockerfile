...
RUN curl -fSsL -O https://bootstrap.pypa.io/get-pip.py \
 && python get-pip.py \
 && rm get-pip.py
RUN pip install Pillow h5py ipykernel jupyter keras_applications==1.0.5 keras_preprocessing==1.0.3 matplotlib mock numpy scipy sklearn pandas --no-cache-dir \
