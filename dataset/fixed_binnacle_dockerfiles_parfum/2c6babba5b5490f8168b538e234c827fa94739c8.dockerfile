...
#  Basic packages
RUN apt-get install --no-install-recommends php5-fpm php5-mysql php-apc php5-imagick php5-imap php5-mcrypt php5-curl php5-cli php5-gd php5-pgsql php5-sqlite php5-common php-pear curl php5-json php5-redis php5-memcache -y
RUN apt-get install --no-install-recommends nginx-extras git curl supervisor -y
RUN apt-get install --no-install-recommends msmtp msmtp-mta -y
