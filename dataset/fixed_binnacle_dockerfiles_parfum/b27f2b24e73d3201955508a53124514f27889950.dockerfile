...
RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime \
 ...
 && apt-get update -y \
 && apt-get install --no-install-recommends ca-certificates gnupg -y \
 ...
 && apt-get update -y \
 && apt-get install --no-install-recommends cron curl gettext libcurl4-openssl-dev libmariadbclient-dev libxml2-dev libssl-dev locales nginx php7.2-curl php7.2-mbstring php7.2-mysql php7.2-xml php7.2-zip php-fpm procps r-base r-base-dev -y \
