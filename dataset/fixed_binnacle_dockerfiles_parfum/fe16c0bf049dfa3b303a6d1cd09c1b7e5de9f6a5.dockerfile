...
RUN apt-get update && apt-get install --no-install-recommends automake curl wget unzip libbz2-dev libncurses5-dev libyaml-dev openjdk-7-jdk openjdk-7-jre r-base r-base-dev r-recommended -y -q
