...
#  Install commons
RUN apt-get install --no-install-recommends apt-transport-https ca-certificates curl jq software-properties-common sudo openjdk-8-jre-headless wget xvfb xfonts-100dpi xfonts-75dpi xfonts-scalable xfonts-cyrillic -qqy
