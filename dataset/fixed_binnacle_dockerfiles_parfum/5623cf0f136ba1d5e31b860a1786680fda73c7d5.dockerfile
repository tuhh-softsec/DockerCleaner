...
RUN apt-get install --no-install-recommends php7.0 php7.0-curl php7.0-bcmath php7.0-bz2 php7.0-dev php7.0-gd php7.0-dom php7.0-imap php7.0-intl php7.0-imagick php7.0-json php7.0-ldap php7.0-mbstring php7.0-mcrypt php7.0-mysql php7.0-oauth php7.0-odbc php7.0-uploadprogress php7.0-ssh2 php7.0-xml php7.0-zip php7.0-solr php7.0-apcu php7.0-opcache php7.0-memcache php7.0-memcached php7.0-redis php7.0-xdebug libapache2-mod-php7.0 -yqq
