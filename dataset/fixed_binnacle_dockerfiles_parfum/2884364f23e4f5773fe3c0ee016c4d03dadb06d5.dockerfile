...
RUN echo "deb http://packages.ros.org/ros/ubuntu $( lsb_release -sc ;) main" > /etc/apt/sources.list.d/ros-latest.list \
 ...
 && apt-get update -y \
 && apt-get install --no-install-recommends ros-kinetic-desktop-full -y \
 && apt-get install --no-install-recommends ros-kinetic-navigation -y \
 && apt-get install --no-install-recommends ros-kinetic-roscpp -y \
 && apt-get install --no-install-recommends ros-kinetic-joy -y \
 && apt-get install --no-install-recommends ros-kinetic-kobuki-safety-controller -y \
 && apt-get install --no-install-recommends ros-kinetic-yocs-velocity-smoother -y \
 && apt-get install --no-install-recommends ros-kinetic-turtlebot-bringup -y \
 && apt-get install --no-install-recommends ros-kinetic-geometry-msgs -y \
 && apt-get install --no-install-recommends ros-kinetic-yocs-cmd-vel-mux -y \
 && apt-get install --no-install-recommends ros-kinetic-diagnostic-aggregator -y \
 && apt-get install --no-install-recommends ros-kinetic-depthimage-to-laserscan -y \
 && apt-get install --no-install-recommends ros-kinetic-gazebo-ros -y \
 && apt-get install --no-install-recommends ros-kinetic-kobuki-gazebo-plugins -y \
 && apt-get install --no-install-recommends ros-kinetic-robot-pose-ekf -y \
 && apt-get install --no-install-recommends ros-kinetic-robot-state-publisher -y \
 && apt-get install --no-install-recommends ros-kinetic-turtlebot-description -y \
 && apt-get install --no-install-recommends ros-kinetic-turtlebot-navigation -y \
 && apt-get install --no-install-recommends ros-kinetic-xacro -y \
 && rosdep init \
 && rosdep update \
...
RUN apt-get update -y \
 && apt-get install --no-install-recommends gazebo7 -y
