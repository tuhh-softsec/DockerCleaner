...
COPY https://github.com/krallin/tini/releases/download/v${TINI_VERSION}/tini-${TINI_COMPILE}-${TINI_ARCH}${TINI_FILEPATH}
# ########################################################
...
COPY https://github.com/tianon/gosu/releases/download/${GOSU_VERSION}/gosu-${GOSU_ARCH}${GOSU_FILEPATH}
# ########################################################
