...
RUN apt-get update -qq
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y openjdk-8-jdk libc6:i386 libstdc++6:i386 libgcc1:i386 libncurses5:i386 libz1:i386
#  ------------------------------------------------------
...
RUN sdkmanager "platforms;android-26" "platforms;android-25" "platforms;android-24" "platforms;android-23" "platforms;android-22" "platforms;android-21" "platforms;android-19" "platforms;android-17" "platforms;android-15" "platforms;android-10" "build-tools;26.0.1" "build-tools;25.0.3" "build-tools;24.0.3" "build-tools;23.0.3" "build-tools;22.0.1" "build-tools;21.1.2" "build-tools;19.1.0" "build-tools;17.0.0" "system-images;android-25;google_apis;armeabi-v7a" "system-images;android-24;default;armeabi-v7a" "system-images;android-22;default;armeabi-v7a" "system-images;android-21;default;armeabi-v7a" "system-images;android-19;default;armeabi-v7a" "extras;android;m2repository" "extras;google;m2repository" "extras;google;google_play_services" "extras;m2repository;com;android;support;constraint;constraint-layout;1.0.2" "extras;m2repository;com;android;support;constraint;constraint-layout;1.0.1" "add-ons;addon-google_apis-google-23" "add-ons;addon-google_apis-google-22" "add-ons;addon-google_apis-google-21"
#  ------------------------------------------------------
#  --- Install Gradle from PPA
#  Gradle PPA
RUN apt-get update \
 && apt-get install --no-install-recommends gradle -y \
 && gradle -v
#  ------------------------------------------------------
...
RUN sudo apt-get update -qq \
 && sudo apt-get install --no-install-recommends -y -qq google-cloud-sdk
...
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y libqt5widgets5
