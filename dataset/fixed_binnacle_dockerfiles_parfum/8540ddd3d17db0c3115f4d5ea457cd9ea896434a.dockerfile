...
RUN apt-get install --no-install-recommends build-essential git python python-dev python-setuptools make cmake gfortran -y
#  Install pip for managing python packages
RUN apt-get install --no-install-recommends python-pip python-lxml -y
RUN pip install cython
RUN apt-get install --no-install-recommends python-lxml -y
...
RUN apt-get update
RUN apt-get install --no-install-recommends libblas3gf libblas-doc libblas-dev -y
RUN apt-get install --no-install-recommends liblapack3gf liblapack-doc liblapack-dev -y
...
RUN apt-get install --no-install-recommends python-matplotlib -y
