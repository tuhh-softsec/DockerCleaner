...
RUN apt-get update \
 && apt-get install --no-install-recommends wget unzip python-pip python-sklearn python-pandas python-numpy python-matplotlib software-properties-common python-software-properties -y \
