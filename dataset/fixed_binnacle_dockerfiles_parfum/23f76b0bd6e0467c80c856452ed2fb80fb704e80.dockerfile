...
RUN apt-get update -y -qq \
 && apt-get install --no-install-recommends netcat openssl apache2 apache2-utils libpcre3 dnsmasq procps apt-transport-https make gcc g++ libxml2 libxml2-dev python-pip curl nano supervisor gunicorn python3-pip zlib1g-dev libpng-dev git python3 python3-dev python3-pip python3-numpy python3-scipy python-imaging -y -qq
#  Install Kong
...
RUN apt-get install --no-install-recommends nodejs -y -qq
