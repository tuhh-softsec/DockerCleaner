...
RUN apt-get update -y --fix-missing \
 && apt-get install --no-install-recommends software-properties-common wget git curl sudo -y \
 && apt-get update
