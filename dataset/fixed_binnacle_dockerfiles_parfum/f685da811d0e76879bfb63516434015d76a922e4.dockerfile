...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends apache2 openssl php5 php5-cli php5-gd php5-mysql php-pear php5-curl postfix sudo rsync git-core unzip wget mysql-client -y -qq
ENV AEGIR_UID="1000"
