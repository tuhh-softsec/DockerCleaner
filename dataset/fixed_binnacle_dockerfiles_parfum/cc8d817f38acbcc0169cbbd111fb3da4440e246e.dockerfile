...
#  Required packages
RUN apt-get update
RUN apt-get install --no-install-recommends build-essential python2.7-dev git ssh libhdf5-dev libssl-dev libxml2-dev libxslt-dev software-properties-common vim pkg-config gfortran libopenblas-dev liblapack-dev python-numpy python-scipy python-matplotlib python-nose libbz2-dev libfreetype6-dev zsh -y
#  Torch and luarocks
