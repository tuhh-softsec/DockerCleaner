...
WORKDIR /home
#  Prerequisites
RUN yum install -y epel-release ; yum install -y -q libxcb SDL2 libass numactl glib2-2.56.1 pango gobject-introspection libpng12 libXv libvisual mesa-libGL pango glib2 alsa-lib openblas-serial libsoup libjpeg-turbo python-yaml ; yum remove -y -q epel-release ; rm -rf /var/cache/yum/*
#  Install
