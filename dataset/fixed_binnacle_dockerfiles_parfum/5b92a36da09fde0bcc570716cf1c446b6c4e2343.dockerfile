...
RUN sudo apt-get update \
 && sudo apt-get install --no-install-recommends -y libprotobuf-dev libleveldb-dev libsnappy-dev libopencv-dev libhdf5-serial-dev protobuf-compiler
RUN sudo apt-get update \
 && sudo apt-get install --no-install-recommends -y libboost-all-dev
RUN sudo apt-get update \
 && sudo apt-get install --no-install-recommends -y libatlas-base-dev libgoogle-glog-dev libgflags-dev liblmdb-dev
RUN sudo apt-get update \
 && sudo apt-get install --no-install-recommends -y libhdf5-10 libhdf5-serial-dev libhdf5-dev libhdf5-cpp-11
#  SSD setup
RUN cd ~ \
...
#  Install dev tools
RUN sudo apt-get -y --no-install-recommends install vim tmux
