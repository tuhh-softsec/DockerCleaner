...
RUN apt-get update --quiet --yes \
 && apt-get install --no-install-recommends wget tar unzip lib32stdc++6 lib32z1 git file build-essential ca-certificates openssh-server --quiet --yes \
...
RUN npm install react-native-cli exp@55.0.5 -g
