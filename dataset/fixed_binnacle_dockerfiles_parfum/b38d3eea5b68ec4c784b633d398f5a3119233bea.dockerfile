...
RUN apt-get install --no-install-recommends supervisor nano vim curl gcc make python python-pip python3 python3-pip locales zip iputils-ping curl git make openssl vim zip net-tools sudo -y
#  Install additional dependencies
RUN apt-get install --no-install-recommends mariadb-client python-mysqldb python-dev python-pip python3-setuptools python-setuptools libxml2-dev libxslt1-dev zlib1g-dev python-setuptools -y
#  Install Apache
...
RUN apt-get install --no-install-recommends libapache2-mod-php php php-cli php-crypt-gpg php-dev php-json php-mysql php-opcache php-readline php-redis php-xml -y
#  Set locals
...
#  Attention: we replaced the fixed tag with a variable
RUN apt-get install --no-install-recommends python-dev python-pip libxml2-dev libxslt1-dev zlib1g-dev python-setuptools
