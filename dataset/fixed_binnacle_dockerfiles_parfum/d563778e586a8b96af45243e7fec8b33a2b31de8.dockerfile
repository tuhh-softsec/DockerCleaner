...
RUN mkdir -p $CONDA_DIR \
 ...
 && apt-get update -y \
 && apt-get install --no-install-recommends wget vim git g++ graphviz software-properties-common python-software-properties python3-dev libhdf5-dev libopenblas-dev liblapack-dev libblas-dev gfortran cpio libmlx4-1 libmlx5-1 librdmacm1 libibverbs1 libmthca1 libdapl2 dapl2-utils -y \
