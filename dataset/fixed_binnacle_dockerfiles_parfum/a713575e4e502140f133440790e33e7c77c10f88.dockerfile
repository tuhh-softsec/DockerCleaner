...
RUN apt-get update -q \
 && apt-mark hold php5.6-cli php5.6-common php5.6-json php7.0-cli php7.0-common php7.0-json php7.2-cli php7.2-common php7.2-json php7.3-cli php7.3-common php7.3-json \
 && apt-get install --no-install-recommends php7.1 php7.1-apcu php7.1-bcmath php7.1-bz2 php7.1-curl php7.1-dev php7.1-fpm php7.1-gd php7.1-igbinary php7.1-intl php7.1-json php7.1-mbstring php7.1-mcrypt php7.1-mysql php7.1-pgsql php7.1-memcache php7.1-memcached php7.1-xml php7.1-yaml php7.1-zip php-xdebug newrelic-php5 newrelic-php5-common newrelic-daemon -yqq \
 && phpdismod pdo_pgsql \
 && phpdismod pgsql \
 && phpdismod yaml \
 && phpdismod xdebug \
