...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends apache2 cron pwgen git-core libapache2-mod-php libpcre3-dev mysql-client mysql-server nano openssh-server php7.2-common php7.2-curl php7.2-cli php7.2-dev php7.2-fpm php7.2-gd php7.2-imap php7.2-json php7.2-opcache php7.2-xml php7.2-mbstring php7.2-mysql php-sqlite3 php-apcu postfix rsync sudo unzip wget vim -y -qq
ENV AEGIR_UID="12345"
