...
RUN apt-get update \
 ...
 && apt-get update \
 && apt-get install --no-install-recommends build-essential cmake curl libboost-all-dev libbz2-dev libcurl3-dev liblzma-dev libncurses5-dev libssl-dev openjdk-7-jdk openjdk-8-jdk python3 python3-pip unzip vim-common wget zlib1g-dev -y \
