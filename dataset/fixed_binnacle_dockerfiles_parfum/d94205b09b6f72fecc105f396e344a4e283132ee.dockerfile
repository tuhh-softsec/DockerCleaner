...
RUN echo 'apt::install-recommends "false";' > /etc/apt/apt.conf.d/no-install-recommends \
 && apt-get update -y \
 && apt-get upgrade -y \
 && apt-get install --no-install-recommends ca-certificates iptables php7.3-bcmath php7.3-bz2 php7.3-cli php7.3-curl php7.3-fpm php7.3-gd php7.3-imap php7.3-intl php7.3-json php7.3-ldap php7.3-mbstring php7.3-mysql php7.3-opcache php7.3-pgsql php7.3-readline php7.3-soap php7.3-sqlite3 php7.3-tidy php7.3-xml php7.3-xmlrpc php7.3-xsl php7.3-zip php-apcu php-geoip php-imagick php-memcache php-ssh2 php-tideways -y \
 && apt-get install --no-install-recommends -y build-essential libmemcached11 libmemcachedutil2 libmemcached-dev php-pear php7.3-dev pkg-config zlib1g-dev \
