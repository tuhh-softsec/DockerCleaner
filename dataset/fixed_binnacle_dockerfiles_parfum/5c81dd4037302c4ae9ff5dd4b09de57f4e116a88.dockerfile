...
RUN apt-get update && apt-get install --no-install-recommends gcc flex rrdtool apache2 tcpdump wget php5 apache2 librrd-dev libapache2-mod-php5 php5-common libio-socket-inet6-perl libio-socket-ssl-perl libmailtools-perl librrds-perl libwww-perl libipc-run-perl perl-base libsys-syslog-perl supervisor net-tools -y
