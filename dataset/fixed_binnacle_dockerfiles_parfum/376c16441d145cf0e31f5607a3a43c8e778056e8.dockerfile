...
#  ----------------------------------------------------------------------------
RUN apt-get update
RUN apt-get install --no-install-recommends software-properties-common vim git-core aptitude portaudio19-dev python3-tk tmux psmisc libsndfile-dev libssl-dev curl -y
...
RUN apt-get update \
 && apt-get install --no-install-recommends nvinfer-runtime-trt-repo-ubuntu1604-4.0.1-ga-cuda9.2 -y \
 && apt-get update \
 && apt-get install --no-install-recommends libnvinfer4=4.1.2-1+cuda9.2 -y \
 && apt-get install --no-install-recommends libnvinfer-dev=4.1.2-1+cuda9.2 -y
