...
RUN apt-get update \
 && apt-get install --no-install-recommends sudo locales git vim-tiny less wget r-base r-base-dev r-recommended fonts-texgyre texinfo locales libudunits2-dev libgdal-dev libgeos-dev libproj-dev -y
...
#  Shiny Server
#  =====================================================================
RUN apt-get install --no-install-recommends gdebi-core pandoc pandoc-citeproc libcurl4-gnutls-dev libcairo2-dev libxt-dev libssl-dev -y
