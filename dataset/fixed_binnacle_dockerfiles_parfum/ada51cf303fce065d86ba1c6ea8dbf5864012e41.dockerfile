...
RUN apt-get update -qq \
 ...
 && apt-get update -qq \
 && apt-get install --no-install-recommends apache2 build-essential curl git libevent-dev libz-dev libjpeg-dev libfuzzy-dev libldap2-dev libpcap-dev libpcre3-dev libsasl2-dev libssl-dev libtool libxml2-dev libxslt1-dev libyaml-dev mongodb-org numactl p7zip-full python-dev python-pip ssdeep swig supervisor upx vim wget zip libapache2-mod-wsgi -y --fix-missing \
