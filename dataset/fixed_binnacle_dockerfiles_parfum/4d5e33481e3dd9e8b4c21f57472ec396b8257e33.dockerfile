...
RUN apt-get update \
 && apt-get install --no-install-recommends build-essential bzip2 cmake curl git libboost-all-dev libbz2-dev libfluidsynth-dev libfreetype6-dev libgme-dev libgtk2.0-dev libjpeg-dev libopenal-dev libpng12-dev libsdl2-dev libwildmidi-dev libzmq3-dev nano nasm pkg-config rsync software-properties-common sudo tar timidity unzip wget zlib1g-dev python3-dev python3 python3-pip -y
#  Python with pip
