...
RUN apt-get update \
 && apt-get install --no-install-recommends git wget cmake python python-pip python3 python3-pip python3-dev g++ libtbb-dev libgl1-mesa-dev libglu1-mesa-dev libxt-dev -y
