...
RUN apt-get install --no-install-recommends wget supervisor -qq -y
#  Instal lighweight DNS for proper nginx name resolution based on /etc/hosts
RUN apt-get install --no-install-recommends dnsmasq -qq -y
...
#  Nginx dependencies
RUN apt-get install --no-install-recommends libpcre3 -qq -y
RUN apt-get install --no-install-recommends libpcre3-dev -qq -y
RUN apt-get install --no-install-recommends zlib1g-dev -qq -y
RUN apt-get install --no-install-recommends libssl-dev -qq -y
#  LUAJit dependencies
