...
RUN dnf -y install gcc-c++ git doxygen cmake bzr vim tar \
 && dnf -y install dialog perl-libwww-perl perl-JSON perl-JSON-PP perl-XML-Parser perl-IPC-Cmd perl-YAML-LibYAML qt5-qtbase-devel \
 && dnf install -y qt5-qtscript-devel gettext-devel gperf flex bison qt5-qtx11extras-devel libXrender-devel xcb-util-keysyms-devel zlib-devel libxslt-devel docbook-style-xsl qt5-qttools-devel qt5-qttools-static qt5-qtsvg-devel systemd-devel qt5-qtquickcontrols2-devel libepoxy-devel boost-devel qt5-qtwebkit-devel libSM-devel pcre-devel qca-ossl openssl-devel giflib-devel libjpeg-turbo-devel libpng-devel libXcursor-devel oxygen-fonts-devel qt5-qtxmlpatterns-devel polkit-devel gstreamer-devel gstreamer-plugins-bad-free-devel gstreamer1-plugins-bad-free-devel gstreamer1-plugins-base-devel NetworkManager-devel NetworkManager-glib-devel NetworkManager-libnm-devel \
 && dnf install -y wayland-devel libwayland-cursor-devel libwayland-server-devel libattr-devel ModemManager-devel xcb-util-image-devel PackageKit-Qt5-devel xorg-x11-xkb-utils-devel libpwquality-devel xorg-x11-drv-synaptics-devel xorg-x11-server-devel gtkmm24-devel gtkmm30-devel lmdb-devel libepoxy-devel fontforge-devel exiv2-devel sane-backends-devel \
 && dnf install -y lcms2-devel hunspell-devel glui-devel qt5-qtmultimedia qt5-qtmultimedia-devel eigen3-devel grantlee-devel qtsinglecoreapplication-devel libarchive-devel alsa-lib alsa-lib-devel openal-soft-devel libsndfile-devel gmp-devel cups-devel qca-devel qca-ossl qca-gnupg qca-pkcs11 \
 && dnf install -y libdmtx-devel qrencode-devel libical-devel cyrus-sasl-devel openldap-devel gpgme-devel \
