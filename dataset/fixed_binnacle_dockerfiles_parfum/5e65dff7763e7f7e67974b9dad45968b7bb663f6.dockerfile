...
RUN dnf -y install git vim supervisor make automake gcc gcc-c++ cmake bison flex pcre-devel pkgconfig protobuf-c-devel libev-devel protobuf-c zlib-devel libssh openssl-devel swig
