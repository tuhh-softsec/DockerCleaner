...
RUN apt-get update \
 && apt-get install --no-install-recommends sudo git libcurl4-openssl-dev libedit-dev libssl-dev libxml2-dev libsqlite3-dev sqlite3 libz-dev libpq-dev libjpeg-dev libpng12-dev libfreetype6-dev libssl-dev libmcrypt-dev libjudydebian1 libjudy-dev cron -y \
 && apt-get clean
#
#  Configure
#
