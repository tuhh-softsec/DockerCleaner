...
# ## Labels
# ##
LABEL name="cytopia's PHP-FPM 7.1 Image" \
...
ENV RUN_DEPS="libaio1  libaspell15  libc-client2007e  libenchant1c2a  libfbclient2  libfreetype6  libicu57  libjpeg62-turbo  libmagickwand-6.q16-3  libmcrypt4  libmemcachedutil2  libnghttp2-14  libpng16-16  libpq5  librabbitmq4  librdkafka1  librecode0  libsybdb5  libtidy5  libvpx4  libwebp6  libxpm4  libxslt1.1  libzip4  snmp  unixodbc  ca-certificates"
# ##
# ## Install
# ##
RUN set -x \
