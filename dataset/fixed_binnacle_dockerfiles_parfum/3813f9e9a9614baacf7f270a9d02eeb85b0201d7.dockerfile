...
RUN apt-get update \
 && apt-get install --no-install-recommends build-essential ca-certificates curl libatlas3-base numactl python-dev python-pip libffi-dev libssl-dev libpcre3 libpcre3-dev git -y \
