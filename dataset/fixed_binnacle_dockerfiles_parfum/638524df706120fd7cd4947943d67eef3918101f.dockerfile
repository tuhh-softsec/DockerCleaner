...
RUN apt-get update \
 && apt-get upgrade -y
RUN apt-get install --no-install-recommends nginx-full supervisor vim varnish -y
RUN apt-get install --no-install-recommends software-properties-common python-software-properties build-essential -y
RUN apt-get install --no-install-recommends curl ca-certificates -y
...
RUN apt-get update
RUN apt-get install --no-install-recommends php7.2 php7.2-cli php7.2-curl php7.2-intl php7.2-mbstring php7.2-xml php7.2-zip php7.2-bcmath php7.2-cli php7.2-fpm php7.2-imap php7.2-json php7.2-opcache php7.2-apcu php7.2-xmlrpc php7.2-bz2 php7.2-common php7.2-gd php7.2-ldap php7.2-pgsql php7.2-readline php7.2-soap php7.2-tidy php7.2-xsl php-apcu -y
