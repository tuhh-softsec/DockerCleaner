...
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends openssh-server sudo curl gdebi-core sshpass cron netcat net-tools crudini uuid-runtime apache2-utils bash-completion -y
