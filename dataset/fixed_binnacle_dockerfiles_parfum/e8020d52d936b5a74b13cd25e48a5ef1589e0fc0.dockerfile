...
# ##
FROM openjdk:12-ea-15-jdk-oraclelinux7
...
#  Install Gradle Version: 4.10.2
RUN curl --silent --show-error --location --fail --retry 3 --output /tmp/gradle.zip https://services.gradle.org/distributions/gradle-4.10.2-bin.zip \
