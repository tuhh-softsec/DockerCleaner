...
# -------------------------------------# 
RUN apt-get install --no-install-recommends sudo build-essential gcc-multilib g++-multilib gdb gdb-multiarch python-dev python3-dev python-pip python3-pip default-jdk net-tools nasm vim tmux zsh ctags git binwalk strace ltrace autoconf socat netcat nmap wget exiftool unzip virtualenvwrapper man-db manpages-dev libini-config-dev libssl-dev libffi-dev libglib2.0-dev libc6:i386 libncurses5:i386 libstdc++6:i386 libc6-dev-i386 gcc-arm-none-eabi libnewlib-arm-none-eabi libstdc++-arm-none-eabi-newlib libnewlib-dev qemu qemu-user qemu-user-static -y
...
# -------------------------------------# 
RUN pip install pycipher uncompyle ropgadget distorm3 filebytes python-constraint
#  install pwntools 3 
