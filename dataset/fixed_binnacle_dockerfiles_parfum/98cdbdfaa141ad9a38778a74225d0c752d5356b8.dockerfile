...
RUN echo "\ndeb http://archive.ubuntu.com/ubuntu/ vivid main" >> /etc/apt/sources.list \
 && apt-get update \
 && apt-get install --no-install-recommends python-six
