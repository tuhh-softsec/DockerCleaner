...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends apache2 curl php-common php-cli php-dev php-fpm libpcre3-dev php-gd php-curl php-imap php-json php-opcache php-xml php-mbstring php-mysql php-sqlite3 php-apcu libapache2-mod-php cron postfix sudo rsync git-core unzip wget mysql-client -y -qq
