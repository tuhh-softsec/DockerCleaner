...
RUN apt-get update -y \
 ...
 && apt-get -y upgrade \
 && apt-get install --no-install-recommends sudo build-essential python3-dev python3-pip ca-certificates curl git gfortran libblas-dev liblapack-dev libssl-dev libffi-dev libcurl4-openssl-dev libgdal-dev wget jq language-pack-en libcurl4-openssl-dev libffi-dev libzmq3-dev libxml2-dev libxslt-dev python3-lxml zlib1g-dev python3-mysqldb -y \
 && apt-get clean \
