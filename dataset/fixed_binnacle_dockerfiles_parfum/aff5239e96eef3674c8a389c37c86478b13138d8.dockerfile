...
# ######################
RUN apt-get update \
 && apt-get install --no-install-recommends libcurl4-openssl-dev libpcre3-dev git libmysqlclient-dev mysql-client secure-delete libqt4-dev libqtwebkit-dev -y \
 && apt-get clean \
