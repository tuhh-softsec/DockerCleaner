...
RUN apt-get update \
 ...
 && apt-get install --no-install-recommends -y wget curl git bash-completion apt-transport-https ca-certificates \
 && cp /etc/skel/.bashrc ~/ \
 ...
 && apt-get update \
 && apt-get install -y --no-install-recommends php7.2-apc php7.2-apcu php7.2-bcmath php7.2-bz2 php7.2-cli php7.2-cgi php7.2-curl php7.2-fpm php7.2-geoip php7.2-gd php7.2-intl php7.2-imagick php7.2-imap php7.2-ldap php7.2-mbstring php7.2-memcached php7.2-mongo php7.2-mysql php7.2-pgsql php7.2-redis php7.2-soap php7.2-sqlite3 php7.2-ssh2 php7.2-zip php7.2-xmlrpc php7.2-xsl php7.2-xdebug \
