...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends apache2 cron curl libpcre3-dev git-core mysql-client postfix rsync sudo unzip vim wget -y -qq
ENV LC_ALL="C.UTF-8"
...
RUN add-apt-repository ppa:ondrej/php \
 ...
 && apt-get update -qq
#  PHP 7.2
RUN apt-get install --no-install-recommends php7.2 php7.2-cli php7.2-curl php7.2-fpm php7.2-gd php7.2-json php7.2-mbstring php7.2-mysql php7.2-sqlite3 php7.2-xml -y -qq
#  PHP 7.1
RUN apt-get install --no-install-recommends php7.1 php7.1-cli php7.1-curl php7.1-fpm php7.1-gd php7.1-json php7.1-mbstring php7.1-mysql php7.1-sqlite3 php7.1-xml -y -qq
#  PHP 7.0
RUN apt-get install --no-install-recommends php7.0 php7.0-cli php7.0-curl php7.0-fpm php7.0-gd php7.0-json php7.0-mbstring php7.0-mysql php7.0-sqlite3 php7.0-xml -y -qq
#  PHP 5.6
RUN apt-get install --no-install-recommends php5.6 php5.6-cli php5.6-curl php5.6-fpm php5.6-gd php5.6-json php5.6-mbstring php5.6-mysql php5.6-sqlite3 php5.6-xml -y -qq
