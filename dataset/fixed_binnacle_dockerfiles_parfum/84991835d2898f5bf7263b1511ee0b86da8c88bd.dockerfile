...
#  install SNAPPY
RUN apt-get install --no-install-recommends default-jdk maven -y
...
WORKDIR /src
COPY https://api.github.com/repos/$SOURCE_GIT_REMOTE/$SOURCE_GIT_REPO/git/refs/$SOURCE_GIT_TYPE/$SOURCE_GIT_REF version.json
