...
RUN apt-get update -q \
 ...
 && apt-get install --no-install-recommends php5.6 php5.6-apcu php5.6-bcmath php5.6-bz2 php5.6-curl php5.6-dev php5.6-fpm php5.6-gd php5.6-igbinary php5.6-intl php5.6-json php5.6-mbstring php5.6-mcrypt php5.6-mysql php5.6-pgsql php5.6-memcache php5.6-memcached php5.6-xdebug php5.6-xml php5.6-yaml php5.6-zip newrelic-php5 newrelic-php5-common newrelic-daemon -yqq \
 && phpdismod pdo_pgsql \
 && phpdismod pgsql \
 && phpdismod yaml \
 && phpdismod xdebug \
