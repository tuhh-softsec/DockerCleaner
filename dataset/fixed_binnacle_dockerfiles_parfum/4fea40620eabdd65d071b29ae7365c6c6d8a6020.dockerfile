...
RUN apt-get update -yqq \
 ...
 && buildDeps="autoconf automake cmake curl bzip2 libexpat1-dev g++ gcc git gperf libtool make perl pkg-config python libssl-dev yasm zlib1g-dev" \
 && apt-get update -yqq \
 ...
 && ./configure --bindir="${SRC}/bin" --disable-debug --disable-doc --disable-ffplay --enable-shared --enable-avresample --enable-gpl --enable-libass --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libfdk_aac --enable-libfreetype --enable-libvidstab --enable-libmp3lame --enable-libopus --enable-libtheora --enable-libvorbis --enable-libvpx --enable-libx264 --enable-libx265 --enable-libxvid --enable-nonfree --enable-openssl --enable-postproc --enable-shared --enable-small --enable-version3 --extra-cflags="-I${SRC}/include" --extra-ldflags="-L${SRC}/lib" --extra-libs=-ldl --prefix="${SRC}" \
 && make \
 && make install \
 && make distclean \
 && hash -r \
