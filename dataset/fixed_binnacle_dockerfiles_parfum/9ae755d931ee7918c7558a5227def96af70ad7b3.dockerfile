...
RUN apt-get update \
 && apt-get install --no-install-recommends libpng-dev libjpeg-dev libxml2-dev libxslt-dev libgraphicsmagick1-dev graphicsmagick libjpeg-turbo-progs optipng pngquant gifsicle webp -y \
