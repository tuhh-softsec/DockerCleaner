...
RUN apt-get install --no-install-recommends git supervisor curl wget php5-curl php5-fpm php5-gd php5-mongo php5-memcached php5-mysql php5-mcrypt php5-sqlite php5-xdebug php5-apcu nginx -my
RUN apt-get install --no-install-recommends pkg-config libssl-dev -my
...
RUN apt-get update \
 && apt-get install --no-install-recommends php5-dev php5-cli php-pear php5-mongo curl nano unzip -y
