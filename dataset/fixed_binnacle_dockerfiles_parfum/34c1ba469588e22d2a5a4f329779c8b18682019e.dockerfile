...
RUN apt-get install --no-install-recommends build-essential software-properties-common nano curl git unzip wget sudo netcat openssl libpcre3 dnsmasq procps perl -y
