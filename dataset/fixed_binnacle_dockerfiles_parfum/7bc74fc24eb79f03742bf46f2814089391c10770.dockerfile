...
RUN apt-get install --no-install-recommends ruby ruby-dev libbit-vector-perl libclass-accessor-class-perl libcrypt-ssleay-perl libio-socket-ssl-perl libnet-ssleay-perl `` `` -y
