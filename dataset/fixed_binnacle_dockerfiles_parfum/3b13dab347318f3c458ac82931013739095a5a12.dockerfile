...
RUN apt-get update \
 && apt-get install --no-install-recommends autoconf automake autopoint curl gettext git libimage-exiftool-perl libtool nano pkg-config python-dev python-pip sudo -yq
#  Install Mongo
