...
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y wget curl net-tools vim git man-db inotify-tools locate
...
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y apache2 apache2-utils
#  Install PHP packages
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y php7.0 php7.0-cli libapache2-mod-php7.0 php7.0-mysql php7.0-curl php7.0-gd php7.0-opcache php7.0-xml php7.0-dom php7.0-zip php7.0-mbstring php7.0-soap php-apcu
RUN DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -y graphicsmagick
