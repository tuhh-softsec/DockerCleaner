...
RUN apt-get install --no-install-recommends autotools-dev -y
...
RUN apt-get install --no-install-recommends libopenmpi-dev -y
RUN apt-get install --no-install-recommends openmpi-bin -y
RUN apt-get install --no-install-recommends gettext -y
RUN apt-get install --no-install-recommends pkg-config -y
RUN apt-get install --no-install-recommends cmake -y
RUN apt-get install --no-install-recommends libffi-dev -y
...
RUN apt-get install --no-install-recommends liblapacke-dev -y
RUN apt-get install --no-install-recommends fftw3 -y
RUN apt-get install --no-install-recommends fftw3-dev -y
RUN apt-get install --no-install-recommends libasound-dev -y
RUN apt-get install --no-install-recommends portaudio19-dev -y
RUN apt-get install --no-install-recommends libsndfile1-dev -y
RUN apt-get install --no-install-recommends libtag1-dev -y
RUN apt-get install --no-install-recommends alsa-utils -y
RUN apt-get install --no-install-recommends qtbase5-dev -y
RUN apt-get install --no-install-recommends qtdeclarative5-dev -y
RUN apt-get install --no-install-recommends libqt5webkit5-dev -y
RUN apt-get install --no-install-recommends libsqlite3-dev -y
RUN apt-get install --no-install-recommends qt5-default qttools5-dev-tools -y
RUN apt-get install --no-install-recommends libqt5opengl5-dev -y
RUN apt-get install --no-install-recommends qtbase5-private-dev -y
RUN apt-get install --no-install-recommends qtdeclarative5-dev -y
RUN apt-get install --no-install-recommends libhdf5-dev -y
RUN apt-get install --no-install-recommends hdf5-tools -y
RUN apt-get install --no-install-recommends libmatio-dev -y
RUN apt-get install --no-install-recommends libslicot0 -y
