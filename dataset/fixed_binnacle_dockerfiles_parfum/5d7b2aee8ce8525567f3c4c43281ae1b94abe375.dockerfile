...
RUN mkdir -p /var/hyperledger/db /var/hyperledger/production $GOPATH/src/github.com/hyperledger $FABRIC_CFG_PATH /chaincode/input /chaincode/output $FABRIC_CA_SERVER_HOME $FABRIC_CA_CLIENT_HOME $CA_CFG_PATH /var/hyperledger/fabric-ca-server
