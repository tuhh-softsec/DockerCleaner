...
#
RUN apt-get install --no-install-recommends mysql-client php5-fpm php5-mysql pwgen python-setuptools curl git unzip -y
#  **Wordpress** Dependencies
RUN apt-get install --no-install-recommends php5-curl php5-gd php5-intl php-pear php5-imagick php5-imap php5-mcrypt php5-memcache php5-ming php5-ps php5-pspell php5-recode php5-sqlite php5-tidy php5-xmlrpc php5-xsl -y
# ## ---- FIX -----
...
RUN add-apt-repository ppa:rtcamp/nginx \
 ...
 && apt-get install --no-install-recommends nginx-custom -y
# ###########################################################
#  Configurations
#
#  ----------------------------------------------------------
