...
RUN apt-get update -y \
 && apt-get install --no-install-recommends autoconf automake expect curl g++ gcc git libqt5widgets5 lib32z1 lib32stdc++6 make maven openjdk-8-jdk python-dev python3-dev qml-module-qtquick-controls qtdeclarative5-dev unzip xz-utils locales -y \
