...
# ## "system-requirements"
RUN apt-get install --no-install-recommends apache2
RUN apt-get install --no-install-recommends curl
RUN apt-get install --no-install-recommends postfix
RUN apt-get install --no-install-recommends mailutils
RUN apt-get install --no-install-recommends rsyslog
RUN apt-get install --no-install-recommends sqlite3
RUN apt-get install --no-install-recommends php
RUN apt-get install --no-install-recommends libapache2-mod-php
RUN apt-get install --no-install-recommends php-date
RUN apt-get install --no-install-recommends php-dom
RUN apt-get install --no-install-recommends php-mbstring
RUN apt-get install --no-install-recommends php-sqlite3
