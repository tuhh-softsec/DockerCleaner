...
WORKDIR /pcap
#  Add some scripts
COPY https://github.com/blacktop/docker-bro/raw/master/scripts/log-passwords.bro /usr/local/share/bro/passwords/log-passwords.bro
COPY https://github.com/blacktop/docker-bro/raw/master/scripts/conn-add-geodata.bro /usr/local/share/bro/geodata/conn-add-geodata.bro
COPY https://github.com/moshekaplan/bro_zipfilenames/raw/master/zipfilenames.bro /usr/local/share/bro/zip/zipfilenames.bro
