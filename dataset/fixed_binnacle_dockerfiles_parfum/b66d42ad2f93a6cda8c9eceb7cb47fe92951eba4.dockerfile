...
RUN BUILD_DEPS='software-properties-common' \
 ...
 && apt-get update \
 && apt-get install --no-install-recommends curl apache2 libsasl2-modules libapache2-mod-php7.3 php7.3-cli php7.3-readline php7.3-mbstring php7.3-zip php7.3-intl php7.3-xml php7.3-json php7.3-curl php7.3-gd php7.3-pgsql php7.3-mysql php-pear -y \
 && apt-get update \
