...
RUN mkdir -p /opt/prometheus/etc \
 && curl http://central.maven.org/maven2/io/prometheus/jmx/jmx_prometheus_javaagent/0.10/jmx_prometheus_javaagent-0.10.jar -o /opt/prometheus/jmx_prometheus_javaagent.jar
...
RUN mkdir -p /opt/jolokia/etc \
 && curl http://central.maven.org/maven2/org/jolokia/jolokia-jvm/1.5.0/jolokia-jvm-1.5.0-agent.jar -o /opt/jolokia/jolokia.jar
