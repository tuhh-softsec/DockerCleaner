...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends build-essential libsdl1.2-dev zlib1g-dev libsdl-mixer1.2-dev libsdl-image1.2-dev git curl wget ca-certificates build-essential -y \
