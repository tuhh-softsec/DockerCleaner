...
ENV ELASTICSEARCH_DEB_VERSION="6.2.4"
#   copy source code
RUN wget -q https://github.com/elastic/elasticsearch/archive/v6.2.4.tar.gz -O /usr/local/src/elasticsearch-source-v6.2.4.tar.gz
RUN set -x \
