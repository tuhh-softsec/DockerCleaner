...
RUN yum clean all \
 ...
 && locale/make_mo.sh \
 && yum autoremove -y gettext svn gcc automake mariadb-devel java-1.8.0-openjdk-devel libxml2-devel libcurl-devel OpenIPMI-devel iksemel-devel rubygems ruby-devel kernel-headers \
