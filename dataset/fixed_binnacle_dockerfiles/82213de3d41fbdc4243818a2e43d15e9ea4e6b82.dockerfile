...
LABEL org.opendap.hyrax.version="1.15.2"
LABEL org.opendap.hyrax.release-date="2018-12-10"
...
ENV LIBDAP_VERSION="3.20.2-1"
ENV BES_VERSION="3.20.2-1"
ENV OLFS_VERSION="1.18.2"
#   RELEASE URLs
