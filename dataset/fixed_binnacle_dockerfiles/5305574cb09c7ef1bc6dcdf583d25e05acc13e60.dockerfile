...
RUN yum install --setopt=keepcache=0 -y ed glibc.i686 make man ncurses-devel openssh-clients openssl-devel redhat-lsb-core rpm-build ruby rubygems rubygem-rake tar unzip which
#   JDK for Jenkins.
...
RUN yum install --setopt=keepcache=0 -y https://centos6.iuscommunity.org/ius-release.rpm \
 ...
 && pip install pip==23.1 PyInstaller==3.1 --upgrade -Iv
