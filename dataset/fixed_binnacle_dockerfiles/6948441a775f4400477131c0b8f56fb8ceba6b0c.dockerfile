...
RUN zypper --non-interactive in perl-libwww-perl perl-XML-Parser perl-JSON perl-YAML-LibYAML perl-IO-Socket-SSL dialog python ca-certificates libqt4-devel
RUN zypper --non-interactive in --force-resolution libQt5DBus-devel ca-certificates-mozilla libQt5Test-devel gettext-tools libQt5Concurrent-devel libqt5-qtscript-devel libqt5-qtx11extras-devel xcb-util-keysyms-devel libxslt-devel docbook-xsl-stylesheets libqt5-qttools-devel libQt5PrintSupport-devel libudev-devel libqt5-qtsvg-devel libepoxy-devel boost-devel libQt5WebKit5-devel libQt5WebKitWidgets-devel giflib-devel libQt5PlatformSupport-private-headers-devel libqt5-qtxmlpatterns-devel libpolkit-qt-1-devel vlc-devel libQt5OpenGL-devel gstreamer-editing-services-devel ModemManager-devel NetworkManager-devel
RUN zypper --non-interactive in libpwquality-devel gtk2-devel gtk3-devel libattr-devel fontforge-devel xcb-util-image-devel xf86-input-synaptics-devel xorg-x11-util-devel libX11-devel libxkbcommon-x11-devel xf86-input-wacom-devel libxapian-devel lmdb-devel
RUN zypper --non-interactive in grantlee5-devel libexiv2-devel hunspell-devel sane-backends-devel glu-devel automoc4 libqt5-qtmultimedia-devel eigen3-devel gmp-devel cups-devel libarchive-devel alsa-devel libsndfile-devel openal-soft-devel libqca-qt5-devel
RUN zypper --non-interactive in libdmtx-devel qrencode-devel libical-devel cyrus-sasl-devel openldap2-devel libgpgme-devel
