...
ENV GPG_KEYS="7BD5DCD0 31CBD89E 70D12172"
...
COPY 7BD5DCD0.asc /tmp/
COPY 31CBD89E.asc /tmp/
COPY 70D12172.asc /tmp/
...
RUN set -xe \
 && apk add curl-dev libedit-dev libxml2-dev libressl-dev apache2-dev coreutils freetype-dev libjpeg-turbo-dev libpng-dev libmcrypt-dev libsodium-dev $PHPIZE_DEPS --no-cache --virtual .build-deps \
