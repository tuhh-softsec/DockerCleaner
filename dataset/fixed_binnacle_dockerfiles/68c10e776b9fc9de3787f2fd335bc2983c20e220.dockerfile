...
RUN echo "deb http://packages.ros.org/ros/ubuntu $( lsb_release -sc ;) main" > /etc/apt/sources.list.d/ros-latest.list \
 ...
 && aptitude install -y -q -R ros-indigo-desktop-full python-rosinstall ninja-build python3-pip python3-setuptools ros-indigo-rosbridge-library ros-indigo-rosbridge-server ros-indigo-rosbridge-suite
