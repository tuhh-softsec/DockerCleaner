...
#   ##################### DOCKER #####################
#   BUILD
#   docker build -t angular4/quickstart-cli:1.0.0 .
#
#   RUN (add -d parameter to start a container in detached mode)
#   docker run -P -it --rm -p 4200:4200 --name angular4-quickstart-cli angular4/quickstart-cli:1.0.0
#
#   STOP
#   docker stop angular4-quickstart-cli
#
#   REMOVE CONTAINER AND IMAGE
#   docker rm -f angular4-quickstart-cli ; docker rmi -f angular4/quickstart-cli:1.0.0
#
#   LOGIN INTO CONTAINER
#   docker exec -i -t angular4-quickstart-cli /bin/bash
#
#   COPY FILE FROM CONTAINER TO HOST
#   docker cp angular4-quickstart-cli:/home/app/angular/package.json ./package.json
#   ##################### DOCKER #####################
#
#   ********************** INIT **********************
