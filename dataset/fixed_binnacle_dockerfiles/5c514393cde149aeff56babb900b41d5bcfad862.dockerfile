...
RUN rm -rf /etc/yum.repos.d/CentOS-Base.repo /etc/yum.repos.d/CentOS-CR.repo /etc/yum.repos.d/CentOS-Debuginfo.repo /etc/yum.repos.d/CentOS-fasttrack.repo /etc/yum.repos.d/CentOS-Media.repo /etc/yum.repos.d/CentOS-Sources.repo /etc/yum.repos.d/CentOS-Vault.repo
...
RUN yum -y install wget epel-release sudo json-c-devel fuse git gcc-c++-4.8.5-16.el7_4.2 python-devel-2.7.5-58.el7 gnutls-devel-3.3.26-9.el7 libacl-devel-2.2.51-12.el7 openldap-devel-2.4.44-5.el7 samba-4.6.2-12.el7_4 samba-client-4.6.2-12.el7_4 cifs-utils-6.2-10.el7 gcc-4.8.5-16.el7_4.2 make-3.82-23.el7 autoconf-2.69-11.el7 automake-1.13.4-3.el7 libtool-2.4.2-22.el7_3
...
RUN pip install requests==2.28.2 tox==3.5.3
#   Install Golang
ENV GOLANG_TARFILE_NAME="go1.11.4.linux-amd64.tar.gz"
RUN cd /tmp \
 && wget -q https://dl.google.com/go/${GOLANG_TARFILE_NAME}
