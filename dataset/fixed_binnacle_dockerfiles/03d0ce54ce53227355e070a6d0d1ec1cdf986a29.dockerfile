...
RUN set -eux ; apt-get update ; apt-get install --no-install-recommends ca-certificates wget bzr git mercurial openssh-client subversion gsfonts imagemagick -y ; rm -rf /var/lib/apt/lists/*
