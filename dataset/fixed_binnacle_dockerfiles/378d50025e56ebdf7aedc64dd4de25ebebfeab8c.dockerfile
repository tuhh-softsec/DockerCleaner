...
ENV DEL_LIB_PHP_DIR="/usr/lib/php/20131226  /usr/lib/php/20151012  /usr/lib/php/20160303  /usr/lib/php/7.2  /usr/lib/php/${PHP_VER}"
...
RUN apt-get update \
 && apt-get install --no-install-recommends php-xdebug=3.2.0+3.1.6+2.9.8+2.8.1+2.5.5-3 php${PHP_VER}-bcmath php${PHP_VER}-cli php${PHP_VER}-curl php${PHP_VER}-intl php${PHP_VER}-json php${PHP_VER}-mbstring php${PHP_VER}-mysql php${PHP_VER}-opcache php${PHP_VER}-xml php${PHP_VER}-zip php${PHP_VER}-amqp php${PHP_VER}-apcu php${PHP_VER}-gd php${PHP_VER}-geoip php${PHP_VER}-gnupg php${PHP_VER}-igbinary php${PHP_VER}-imagick php${PHP_VER}-mailparse php${PHP_VER}-memcached php${PHP_VER}-mongodb php${PHP_VER}-oauth php${PHP_VER}-radius php${PHP_VER}-raphf php${PHP_VER}-redis php${PHP_VER}-soap php${PHP_VER}-solr php${PHP_VER}-sqlite3 php${PHP_VER}-ssh2 php${PHP_VER}-stomp php${PHP_VER}-uploadprogress php${PHP_VER}-uuid php${PHP_VER}-zmq --no-install-suggests -y \
 && apt-get -y --purge autoremove \
 && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/* /usr/share/{man,doc}
...
RUN rm -f /etc/php/${PHP_VER}/cli/conf.d/20-amqp.ini /etc/php/${PHP_VER}/cli/conf.d/20-apcu.ini /etc/php/${PHP_VER}/cli/conf.d/20-gd.ini /etc/php/${PHP_VER}/cli/conf.d/20-geoip.ini /etc/php/${PHP_VER}/cli/conf.d/20-gnupg.ini /etc/php/${PHP_VER}/cli/conf.d/20-imagick.ini /etc/php/${PHP_VER}/cli/conf.d/25-mailparse.ini /etc/php/${PHP_VER}/cli/conf.d/25-memcached.ini /etc/php/${PHP_VER}/cli/conf.d/20-mongodb.ini /etc/php/${PHP_VER}/cli/conf.d/20-oauth.ini /etc/php/${PHP_VER}/cli/conf.d/20-pdo_sqlite.ini /etc/php/${PHP_VER}/cli/conf.d/20-radius.ini /etc/php/${PHP_VER}/cli/conf.d/20-raphf.ini /etc/php/${PHP_VER}/cli/conf.d/20-redis.ini /etc/php/${PHP_VER}/cli/conf.d/20-soap.ini /etc/php/${PHP_VER}/cli/conf.d/20-solr.ini /etc/php/${PHP_VER}/cli/conf.d/20-sqlite3.ini /etc/php/${PHP_VER}/cli/conf.d/20-ssh2.ini /etc/php/${PHP_VER}/cli/conf.d/20-stomp.ini /etc/php/${PHP_VER}/cli/conf.d/20-uploadprogress.ini /etc/php/${PHP_VER}/cli/conf.d/20-uuid.ini /etc/php/${PHP_VER}/cli/conf.d/20-zmq.ini /etc/php/${PHP_VER}/cli/conf.d/20-xdebug.ini \
