...
RUN apk add libstdc++=8.3.0-r0 libx11=1.6.12-r0 libxrender=0.9.10-r3 libxext=1.3.3-r3 libssl1.1=1.1.1k-r0 ca-certificates=20191127-r2 fontconfig=2.13.1-r0 freetype=2.9.1-r3 ttf-dejavu=2.37-r1 ttf-droid=20121017-r0 ttf-freefont=20120503-r1 ttf-liberation=2.00.1-r1 ttf-ubuntu-font-family=0.83-r0 --no-cache \
 && apk add g++=8.3.0-r0 git=2.20.4-r0 gtk+=2.24.31-r0 gtk+-dev=2.24.31-r0 make=4.2.1-r2 mesa-dev=18.1.7-r2 msttcorefonts-installer=3.6-r2 openssl-dev=1.1.1k-r0 patch=2.7.6-r6 fontconfig-dev=2.13.1-r0 freetype-dev=2.9.1-r3 --no-cache --virtual .build-deps \
 && update-ms-fonts \
 && fc-cache -f \
