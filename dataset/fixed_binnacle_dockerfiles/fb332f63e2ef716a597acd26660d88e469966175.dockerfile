...
RUN echo 'APT::Get::AllowUnauthenticated "true";\nAPT::Get::Assume-Yes "true";' | tee /etc/apt/apt.conf.d/99opennetworklinux \
 ...
 && apt-get install --no-install-recommends python-pyroute2
#
