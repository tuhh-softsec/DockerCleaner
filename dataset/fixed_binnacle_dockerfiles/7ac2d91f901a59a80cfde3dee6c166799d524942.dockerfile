...
RUN set -xe \
 && apk add coreutils=8.30-r0 curl-dev=7.64.0-r5 libedit-dev=20181209.3.1-r0 libxml2-dev=2.9.9-r3 openssl-dev=1.1.1k-r0 sqlite-dev=3.28.0-r3 $PHPIZE_DEPS --no-cache --virtual .build-deps \
