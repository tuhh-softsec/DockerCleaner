...
RUN apt-get install --no-install-recommends php7.0=7.0.33-0ubuntu0.16.04.16 php7.0-cli=7.0.33-0ubuntu0.16.04.16 php7.0-dev=7.0.33-0ubuntu0.16.04.16 php-pear=1:1.10.1+submodules+notgz-6ubuntu0.3 re2c=0.16-1 composer=1.0.0~beta2-1 `` -y
