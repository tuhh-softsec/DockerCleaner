...
RUN set -ex \
 ...
 && rm python.tar.xz \
 && apk add bzip2-dev=1.0.6-r7 coreutils=8.29-r2 dpkg-dev=1.18.24-r0 dpkg=1.18.24-r0 expat-dev=2.2.8-r0 findutils=4.6.0-r1 gcc=6.4.0-r9 gdbm-dev=1.13-r1 libc-dev=0.7.1-r0 libffi-dev=3.2.1-r4 libnsl-dev=1.0.5-r2 libtirpc-dev=1.0.3-r0 linux-headers=4.4.6-r2 make=4.2.1-r2 ncurses-dev=6.1_p20180818-r1 libressl-dev=2.7.5-r0 pax-utils=1.2.3-r0 readline-dev=7.0.003-r0 sqlite-dev=3.25.3-r4 tcl-dev=8.6.7-r0 tk=8.6.6-r2 tk-dev=8.6.6-r2 zlib-dev=1.2.11-r1 --no-cache --virtual .build-deps \
 && apk del .fetch-deps \
 && cd /usr/src/python \
