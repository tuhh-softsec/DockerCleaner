...
RUN apt-get update \
 && apt-get install --no-install-recommends build-essential=12.4ubuntu1 cmake=3.10.2-1ubuntu2.18.04.2 curl=7.58.0-2ubuntu3.24 file=1:5.32-2ubuntu0.4 git=1:2.17.1-1ubuntu0.17 musl-dev=1.1.19-1 musl-tools=1.1.19-1 libpq-dev=10.23-0ubuntu0.18.04.1 libsqlite-dev libssl-dev=1.1.1-1ubuntu2.1~18.04.21 linux-libc-dev=4.15.0-208.220 pkgconf=0.9.12-6 sudo=1.8.21p2-3ubuntu1.5 xutils-dev=1:7.7+5ubuntu1 gcc-multilib-arm-linux-gnueabihf=4:7.4.0-1ubuntu2.3 -y \
 && apt-get clean \
