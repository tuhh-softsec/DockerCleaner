...
RUN echo "http://dl-cdn.alpinelinux.org/alpine/latest-stable/main" >> /etc/apk/repositories \
 && apk update \
 && apk upgrade \
 && apk add bash=4.4.19-r1 git=2.18.4-r0 python2=2.7.15-r3 py2-argparse=1.4.0-r1 py2-tz=2018.4-r0 py2-pysqlite=2.8.3-r1 py2-flask=0.12.2-r1 py2-pygments=2.2.0-r0 python2-tkinter=2.7.14-r0 py2-pip=10.0.1-r0 --update \
 ...
 && pip install peewee==3.16.0 tzlocal==4.3 \
