...
RUN (apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 8AA7AF1F1091A5FD 9AD198E9 || apt-key adv --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 8AA7AF1F1091A5FD 9AD198E9 ) \
 ...
 && apt-get update \
 && apt-get install --no-install-recommends git=1:2.7.4-0ubuntu1.10 golang-1.11-go libssl-dev=1.0.2g-1ubuntu4.20 libzmq3-dev=4.1.4-7ubuntu0.1 openssl=1.0.2g-1ubuntu4.20 python3=3.5.1-3 python3-grpcio-tools=1.1.3-1 -y -q \
 && apt-get clean \
 && rm -rf /var/lib/apt/lists/*
RUN go get -u github.com/btcsuite/btcd/btcec github.com/golang/mock/gomock github.com/golang/mock/mockgen github.com/golang/protobuf/proto github.com/golang/protobuf/protoc-gen-go github.com/jessevdk/go-flags github.com/pebbe/zmq4 github.com/satori/go.uuid golang.org/x/crypto/ripemd160 gopkg.in/fatih/set.v0
