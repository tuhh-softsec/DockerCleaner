...
RUN apt-get update \
 && apt-get install --no-install-recommends apparmor=2.10.95-0ubuntu2.6~14.04.4 aufs-tools=1:3.2+20130722-1.1 automake=1:1.14.1-2ubuntu1 bash-completion=1:2.1-4ubuntu0.2 btrfs-tools=3.12-1ubuntu0.2 build-essential=11.6ubuntu6 curl=7.35.0-1ubuntu2.20 dpkg-sig=0.13.1+nmu1 git=1:1.9.1-1ubuntu0.10 iptables=1.4.21-1ubuntu1 libapparmor-dev=2.10.95-0ubuntu2.6~14.04.4 libcap-dev=1:2.24-0ubuntu2 libsqlite3-dev=3.8.2-1ubuntu2.2 mercurial=2.8.2-1ubuntu1.4 parallel=20161222-1~ubuntu0.14.04.2 python-mock=1.0.1-3 python-pip=1.5.4-1ubuntu4 python-websocket=0.12.0-1ubuntu2 reprepro=4.13.1-1build1 ruby1.9.1=1.9.3.484-2ubuntu1.14 ruby1.9.1-dev=1.9.3.484-2ubuntu1.14 ubuntu-zfs libzfs-dev s3cmd=1.1.0* -y
