...
RUN ln -sf /usr/share/zoneinfo/UTC /etc/localtime \
 ...
 && apt-get install --no-install-recommends libnuma1=2.0.11-2.1ubuntu0.1 libssl1.1=1.1.1-1ubuntu2.1~18.04.21 libpciaccess0=0.14-1 python3-tornado=4.5.3-1ubuntu0.2 python3-kafka=1.3.2-0ubuntu1 python3-bs4=4.6.0-1 python3-kazoo=2.2.1-1ubuntu1 vim=2:8.0.1453-1ubuntu1.11 -y -q \
