...
COPY ./jce-unlimited/US_export_policy.jar /tmp/UnlimitedJCEPolicy/US_export_policy.jar
COPY ./jce-unlimited/local_policy.jar /tmp/UnlimitedJCEPolicy/local_policy.jar
RUN mv /tmp/UnlimitedJCEPolicy/*.* $JAVA_HOME/jre/lib/security/
RUN rm -rf /tmp/UnlimitedJCEPolicy*
#   Add CA certs
COPY ./trusted-root-ca/StaatderNederlandenRootCA-G2.pem /tmp/StaatderNederlandenRootCA-G2.pem
...
RUN groupadd -r jboss \
 && useradd -r -g jboss -m -d /home/jboss jboss
#  ###########################################
...
USER root
COPY distribution $INSTALLDIR/distribution
COPY distribution-patches $INSTALLDIR/distribution-patches
...
COPY modules $INSTALLDIR/modules
...
#  ###########################################
EXPOSE 22/tcp 5455/tcp 9999/tcp 8009/tcp 8080/tcp 8443/tcp 3528/tcp 3529/tcp 7500/tcp 45700/tcp 7600/tcp 57600/tcp 5445/tcp 23364/tcp 5432/tcp 8090/tcp 4447/tcp 4712/tcp 4713/tcp 9990/tcp 8787/tcp
