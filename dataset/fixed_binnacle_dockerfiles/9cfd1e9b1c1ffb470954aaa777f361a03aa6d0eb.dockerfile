...
RUN update.sh \
 && install.sh ssl-cert libpython2.7 net-tools netcat xinetd at time traceroute libsnmp-python dialog dnsutils fping graphviz libapache2-mod-fcgid libapache2-mod-proxy-html apache2-mpm-prefork apache2-utils libboost-program-options1.54.0 libboost-system1.54.0 libdbi1 libevent-1.4-2 libnet-snmp-perl libpango1.0-0 libreadline5 libsnmp-perl mysql-server patch php5-cli php5-cgi libradiusclient-ng2 php5-gd php5-mcrypt php5-sqlite php-pear pyro rsync smbclient snmp unzip xvfb python-ldap \
