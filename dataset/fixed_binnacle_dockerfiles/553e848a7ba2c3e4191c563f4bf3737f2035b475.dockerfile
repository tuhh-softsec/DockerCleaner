...
RUN apt-get update \
 && apt-get install --no-install-recommends automake=1:1.15.1-3ubuntu2 build-essential=12.4ubuntu1 ca-certificates=20211016ubuntu0.18.04.1 curl=7.58.0-2ubuntu3.24 git=1:2.17.1-1ubuntu0.17 libcurl3-dev libfreetype6-dev=2.8.1-2ubuntu2.2 libhdf5-dev=1.10.0-patch1+docs-4 libpng-dev=1.6.34-1ubuntu0.18.04.2 libtool=2.4.6-2 libzmq3-dev=4.2.5-1ubuntu0.2 mlocate=0.26-2ubuntu3.1 openjdk-8-jdk=8u362-ga-0ubuntu1~18.04.1 openjdk-8-jre-headless=8u362-ga-0ubuntu1~18.04.1 pkg-config=0.29.1-0ubuntu2 python-dev=2.7.15~rc1-1 software-properties-common=0.96.24.32.20 swig=3.0.12-1 unzip=6.0-21ubuntu1.2 wget=1.19.4-1ubuntu2.2 zip=3.0-11build1 zlib1g-dev=1:1.2.11.dfsg-0ubuntu2.2 -y \
 && apt-get clean \
