...
RUN (apt-get update ;apt-get install --no-install-recommends php7.1 php7.1-curl php7.1-bcmath php7.1-bz2 php7.1-dev php7.1-gd php7.1-dom php7.1-imap php7.1-imagick php7.1-intl php7.1-json php7.1-ldap php7.1-mbstring php7.1-mcrypt php7.1-mysql php7.1-oauth php7.1-odbc php7.1-uploadprogress php7.1-ssh2 php7.1-xml php7.1-zip php7.1-solr php7.1-apcu php7.1-opcache php7.1-memcache php7.1-memcached php7.1-redis php7.1-xdebug libapache2-mod-php7.1 -yqq )
...
RUN echo "extension=apcu.so" > /etc/php/7.1/mods-available/apcu_bc.ini \
...
RUN a2enmod access_compat actions alias auth_basic authn_core authn_file authz_core authz_groupfile authz_host authz_user autoindex dir env expires filter headers mime negotiation php7.1 mpm_prefork reqtimeout rewrite setenvif status ssl
