...
RUN set -ex \
 && apt-get update \
 && apt-get install --no-install-recommends ca-certificates=20210119~16.04.1 cmake=3.5.1-1ubuntu3 g++=4:5.3.1-1ubuntu1 make=4.1-6 pkg-config=0.29.1-0ubuntu1 graphviz=2.38.0-12ubuntu2.1 doxygen=1.8.11-1ubuntu0.1 git=1:2.7.4-0ubuntu1.10 curl=7.47.0-1ubuntu2.19 libtool-bin=2.4.6-0.1 autoconf=2.69-9 automake=1:1.15-4ubuntu1 bzip2=1.0.6-8ubuntu0.2 xsltproc=1.1.28-2.1ubuntu0.3 gperf=3.0.4-2 python3-dev=3.5.1-3 --yes
WORKDIR /usr/local
#  Cmake
