#  +++++++++++++++++++++++++++++++++++++++
#   Dockerfile for webdevops/php-official:5.6
...
RUN set -x \
 ...
 && docker-php-ext-install bcmath bz2 calendar exif intl imap gettext ldap mysqli mcrypt hash pcntl pdo_mysql pdo_pgsql pgsql soap sockets tokenizer sysvmsg sysvsem sysvshm shmop xmlrpc xsl zip gd gettext opcache \
 ...
 && apt-get purge -y -f --force-yes libc-client-dev libkrb5-dev libbz2-dev libicu-dev libldap2-dev libldb-dev libmcrypt-dev libxml2-dev libxslt1-dev zlib1g-dev libpng-dev libpq-dev libzip-dev \
