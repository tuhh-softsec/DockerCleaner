...
#   Install basics
RUN (apt-get update ;apt-get install --no-install-recommends git=1:2.11.0-3+deb9u7 wget=1.18-5+deb9u3 curl=7.52.1-5+deb9u16 zip=3.0-11+b1 unzip=6.0-21+deb9u2 apt-transport-https=1.4.11 ca-certificates=20200601~deb9u2 gnupg=2.1.18-8~deb9u4 -y )
...
RUN (apt-get update ;apt-get install --no-install-recommends locales=2.24-11+deb9u4 golang=2:1.7~5 ruby=1:2.3.3 ruby-dev=1:2.3.3 nodejs=4.8.2~dfsg-1 lib32stdc++6=6.3.0-18+deb9u1 libstdc++6=6.3.0-18+deb9u1 libglu1-mesa=9.0.0-2.1 build-essential=12.3 default-jdk-headless=2:1.8-58+deb9u1 google-chrome-stable -y )
