...
RUN apt-get update \
 && apt-get install --no-install-recommends transmission-cli=2.92-2+deb9u2 transmission-common=2.92-2+deb9u2 transmission-daemon=2.92-2+deb9u2 -y \
 && apt-get install --no-install-recommends dumb-init=1.2.0-1 unzip=6.0-21+deb9u2 openvpn=2.4.0-6+deb9u4 curl=7.52.1-5+deb9u16 ufw=0.35-4 git=1:2.11.0-3+deb9u7 tinyproxy=1.8.4-3~deb9u2 jq=1.5+dfsg-1.3 -y \
