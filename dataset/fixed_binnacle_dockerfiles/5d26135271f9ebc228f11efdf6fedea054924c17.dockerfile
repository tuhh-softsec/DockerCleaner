...
RUN apt-get update \
 && apt-get install --no-install-recommends bash=4.4-5 sudo=1.8.19p1-2.1+deb9u3 build-essential=12.3 cmake=3.7.2-1 ninja-build=1.7.2-1 g++=4:6.3.0-4 gcc-arm-linux-gnueabi=4:6.3.0-4 g++-arm-linux-gnueabi=4:6.3.0-4 libncurses5-dev=6.0+20161126-1+deb9u2 libstdc++-6-dev=6.3.0-18+deb9u1 make=4.1-9.1 pkg-config=0.29-4+b1 python=2.7.13-2 python-dev=2.7.13-2 wget=1.18-5+deb9u3 zlib1g-dev=1:1.2.8.dfsg-5+deb9u1 qemu-user=1:2.8+dfsg-6+deb9u17 vim=2:8.0.0197-4+deb9u7 llvm-$LLVM_VERSION -y \
