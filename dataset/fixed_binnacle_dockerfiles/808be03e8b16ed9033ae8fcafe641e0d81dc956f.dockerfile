...
RUN (apt-get update ;apt-get install --no-install-recommends git=1:2.39.2-1ubuntu1 make=4.3-4.1build1 python ruby=1:3.1 sudo=1.9.13p1-1ubuntu2 locales=2.37-0ubuntu2 curl=7.88.1-7ubuntu1 -y )
