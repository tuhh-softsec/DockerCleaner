...
RUN apt-get update \
 && apt-get install --no-install-recommends ca-certificates=20230311 curl=7.88.1-7ubuntu1 git=1:2.39.2-1ubuntu1 gnupg=2.2.40-1ubuntu2 unzip=6.0-27ubuntu1 zip=3.0-13 --no-install-suggests -y \
...
ENV PHP_VER="7.0"
ARG PHP_VER_DOT
ENV PHP_LIB_DIR="20151012"
#   Deletable dupe module directories not required by this version
ENV DEL_LIB_PHP_DIR="/usr/lib/php/20131226  /usr/lib/php/20160303  /usr/lib/php/20170718  /usr/lib/php/20180731  /usr/lib/php/${PHP_VER}"
#   Deletable extra directories that may be created by installing PHP modules
ENV DEL_PHP_DIR="/etc/php/5.6  /etc/php/7.1  /etc/php/7.2  /etc/php/7.3"
...
RUN apt-get update \
 && apt-get install --no-install-recommends php-xdebug=3.2.0+3.1.6+2.9.8+2.8.1+2.5.5-3 php${PHP_VER}-bcmath php${PHP_VER}-cli php${PHP_VER}-curl php${PHP_VER}-fpm php${PHP_VER}-intl php${PHP_VER}-json php${PHP_VER}-mbstring php${PHP_VER}-mysql php${PHP_VER}-opcache php${PHP_VER}-xml php${PHP_VER}-zip php${PHP_VER}-amqp php${PHP_VER}-apcu php${PHP_VER}-apcu-bc php${PHP_VER}-gd php${PHP_VER}-geoip php${PHP_VER}-gnupg php${PHP_VER}-igbinary php${PHP_VER}-imagick php${PHP_VER}-lua php${PHP_VER}-mailparse php${PHP_VER}-mcrypt php${PHP_VER}-memcached php${PHP_VER}-mongodb php${PHP_VER}-oauth php${PHP_VER}-radius php${PHP_VER}-raphf php${PHP_VER}-redis php${PHP_VER}-soap php${PHP_VER}-sodium php${PHP_VER}-solr php${PHP_VER}-sqlite3 php${PHP_VER}-ssh2 php${PHP_VER}-stomp php${PHP_VER}-uploadprogress php${PHP_VER}-uuid php${PHP_VER}-zmq --no-install-suggests -y \
 && apt-get -y --purge autoremove \
 && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/* /usr/share/{man,doc}
#   Delete directories belonging to other PHP versions
RUN rm -rf ${DEL_LIB_PHP_DIR} ${DEL_PHP_DIR}
#   Install Composer
...
RUN install -d -m 0755 -o www-data -g www-data /var/run/php-fpm /var/lib/php/sessions
...
RUN rm -f /etc/php/${PHP_VER}/cli/conf.d/20-amqp.ini /etc/php/${PHP_VER}/fpm/conf.d/20-amqp.ini /etc/php/${PHP_VER}/cli/conf.d/20-apcu.ini /etc/php/${PHP_VER}/fpm/conf.d/20-apcu.ini /etc/php/${PHP_VER}/cli/conf.d/25-apcu_bc.ini /etc/php/${PHP_VER}/fpm/conf.d/25-apcu_bc.ini /etc/php/${PHP_VER}/cli/conf.d/20-gd.ini /etc/php/${PHP_VER}/fpm/conf.d/20-gd.ini /etc/php/${PHP_VER}/cli/conf.d/20-geoip.ini /etc/php/${PHP_VER}/fpm/conf.d/20-geoip.ini /etc/php/${PHP_VER}/cli/conf.d/20-gnupg.ini /etc/php/${PHP_VER}/fpm/conf.d/20-gnupg.ini /etc/php/${PHP_VER}/cli/conf.d/20-imagick.ini /etc/php/${PHP_VER}/fpm/conf.d/20-imagick.ini /etc/php/${PHP_VER}/cli/conf.d/20-lua.ini /etc/php/${PHP_VER}/fpm/conf.d/20-lua.ini /etc/php/${PHP_VER}/cli/conf.d/25-mailparse.ini /etc/php/${PHP_VER}/fpm/conf.d/25-mailparse.ini /etc/php/${PHP_VER}/cli/conf.d/20-mcrypt.ini /etc/php/${PHP_VER}/fpm/conf.d/20-mcrypt.ini /etc/php/${PHP_VER}/cli/conf.d/25-memcached.ini /etc/php/${PHP_VER}/fpm/conf.d/25-memcached.ini /etc/php/${PHP_VER}/cli/conf.d/20-mongodb.ini /etc/php/${PHP_VER}/fpm/conf.d/20-mongodb.ini /etc/php/${PHP_VER}/cli/conf.d/20-oauth.ini /etc/php/${PHP_VER}/fpm/conf.d/20-oauth.ini /etc/php/${PHP_VER}/cli/conf.d/20-pdo_sqlite.ini /etc/php/${PHP_VER}/fpm/conf.d/20-pdo_sqlite.ini /etc/php/${PHP_VER}/cli/conf.d/20-radius.ini /etc/php/${PHP_VER}/fpm/conf.d/20-radius.ini /etc/php/${PHP_VER}/cli/conf.d/20-raphf.ini /etc/php/${PHP_VER}/fpm/conf.d/20-raphf.ini /etc/php/${PHP_VER}/cli/conf.d/20-redis.ini /etc/php/${PHP_VER}/fpm/conf.d/20-redis.ini /etc/php/${PHP_VER}/cli/conf.d/20-soap.ini /etc/php/${PHP_VER}/fpm/conf.d/20-soap.ini /etc/php/${PHP_VER}/cli/conf.d/20-sodium.ini /etc/php/${PHP_VER}/fpm/conf.d/20-sodium.ini /etc/php/${PHP_VER}/cli/conf.d/20-solr.ini /etc/php/${PHP_VER}/fpm/conf.d/20-solr.ini /etc/php/${PHP_VER}/cli/conf.d/20-sqlite3.ini /etc/php/${PHP_VER}/fpm/conf.d/20-sqlite3.ini /etc/php/${PHP_VER}/cli/conf.d/20-ssh2.ini /etc/php/${PHP_VER}/fpm/conf.d/20-ssh2.ini /etc/php/${PHP_VER}/cli/conf.d/20-stomp.ini /etc/php/${PHP_VER}/fpm/conf.d/20-stomp.ini /etc/php/${PHP_VER}/cli/conf.d/20-uploadprogress.ini /etc/php/${PHP_VER}/fpm/conf.d/20-uploadprogress.ini /etc/php/${PHP_VER}/cli/conf.d/20-uuid.ini /etc/php/${PHP_VER}/fpm/conf.d/20-uuid.ini /etc/php/${PHP_VER}/cli/conf.d/20-zmq.ini /etc/php/${PHP_VER}/fpm/conf.d/20-zmq.ini /etc/php/${PHP_VER}/cli/conf.d/20-xdebug.ini /etc/php/${PHP_VER}/fpm/conf.d/20-xdebug.ini \
 && install -d -m 0755 -o www-data -g www-data /etc/php/extra-mods /etc/php/extra-mods/amqp /etc/php/extra-mods/apcu /etc/php/extra-mods/apcu_bc /etc/php/extra-mods/gd /etc/php/extra-mods/geoip /etc/php/extra-mods/gnupg /etc/php/extra-mods/imagick /etc/php/extra-mods/lua /etc/php/extra-mods/mailparse /etc/php/extra-mods/mcrypt /etc/php/extra-mods/memcached /etc/php/extra-mods/mongodb /etc/php/extra-mods/oauth /etc/php/extra-mods/pdo_sqlite /etc/php/extra-mods/radius /etc/php/extra-mods/raphf /etc/php/extra-mods/redis /etc/php/extra-mods/soap /etc/php/extra-mods/sodium /etc/php/extra-mods/solr /etc/php/extra-mods/sqlite3 /etc/php/extra-mods/ssh2 /etc/php/extra-mods/stomp /etc/php/extra-mods/uploadprogress /etc/php/extra-mods/uuid /etc/php/extra-mods/zmq /etc/php/extra-mods/xdebug \
