...
RUN yum -y install https://repo.mysql.com/yum/mysql-8.0-community/el/7/x86_64/mysql80-community-release-el7-1.noarch.rpm \
 ...
 && cp /root/Tars/framework/build/t*.tgz /root/ \
 ...
 && npm install \
 && npm install pm2@5.3.0 @tars/deploy @tars/stream @tars/rpc @tars/logs @tars/config @tars/monitor @tars/notify @tars/utils @tars/dyeing @tars/registry -g \
 && mkdir -p /root/init \
 && cd /root/init/ \
