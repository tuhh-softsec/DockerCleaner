...
RUN set -eux \
 && apk add autoconf=2.69-r2 automake=1.16.1-r0 coreutils=8.30-r0 curl-dev=7.64.0-r5 libevent-dev=2.1.8-r6 libssh2-dev=1.9.0-r1 libxml2-dev=2.9.9-r3 mysql-dev net-snmp-dev=5.8-r1 openipmi-dev=2.0.25-r1 openldap-dev=2.4.48-r2 pcre-dev=8.42-r2 subversion=1.12.2-r0 unixodbc-dev=2.3.7-r0 alpine-sdk=1.0-r0 ${APK_FLAGS_DEV} --virtual build-dependencies \
 && cd /tmp/ \
