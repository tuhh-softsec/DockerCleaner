...
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends libass-dev=0.13.1-1 libfreetype6-dev=2.6.1-0.1ubuntu2.5 libvdpau-dev=1.1.1-3ubuntu1 libsdl2-dev=2.0.4+dfsg1-2ubuntu2.16.04.2 libxcb1-dev=1.11.1-1ubuntu1 libxcb-shm0-dev=1.11.1-1ubuntu1 libxcb-xfixes0-dev=1.11.1-1ubuntu1 texinfo=6.1.0.dfsg.1-5 zlib1g-dev=1:1.2.8.dfsg-2ubuntu4.3 libssl-dev=1.0.2g-1ubuntu4.20 -y -q
