...
RUN apt-get update \
 && apt-get install --no-install-recommends build-essential=11.6ubuntu6 curl=7.35.0-1ubuntu2.20 git=1:1.9.1-1ubuntu0.10 libfreetype6-dev=2.5.2-1ubuntu2.8 libpng12-dev=1.2.50-1ubuntu2.14.04.3 libzmq3-dev=4.0.4+dfsg-2ubuntu0.1 pkg-config=0.26-1ubuntu4 python-dev=2.7.5-5ubuntu3 python-numpy=1:1.8.2-0ubuntu0.1 python-pip=1.5.4-1ubuntu4 rsync=3.1.0-2ubuntu0.4 software-properties-common=0.92.37.8 swig=2.0.11-1ubuntu2 unzip=6.0-9ubuntu1.5 zip=3.0-8 zlib1g-dev=1:1.2.8.dfsg-1ubuntu1.1 -y \
 && apt-get clean \
