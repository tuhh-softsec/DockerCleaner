...
RUN apt-get install --no-install-recommends python3=3.5.1-3 python3-pip=8.1.1-2ubuntu0.6 python3-setuptools=20.7.0-1 python-yaml=3.11-3build1 -y
...
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends libass-dev=0.13.1-1 libfreetype6-dev=2.6.1-0.1ubuntu2.5 libsdl2-dev=2.0.4+dfsg1-2ubuntu2.16.04.2 libxcb1-dev=1.11.1-1ubuntu1 libxcb-shm0-dev=1.11.1-1ubuntu1 libxcb-xfixes0-dev=1.11.1-1ubuntu1 texinfo=6.1.0.dfsg.1-5 zlib1g-dev=1:1.2.8.dfsg-2ubuntu4.3 libssl-dev=1.0.2g-1ubuntu4.20 -y -q
...
#   Prerequisites
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends libxv1=2:1.0.10-1 libxcb-shm0=1.11.1-1ubuntu1 libxcb-shape0=1.11.1-1ubuntu1 libxcb-xfixes0=1.11.1-1ubuntu1 libsdl2-2.0-0=2.0.4+dfsg1-2ubuntu2.16.04.2 libasound2=1.1.0-0ubuntu1 libnuma1=2.0.11-1ubuntu1.1 libass5=0.13.1-1 libssl1.0.0=1.0.2g-1ubuntu4.20 libglib2.0 libpango-1.0-0=1.38.1-1 libpangocairo-1.0-0=1.38.1-1 gobject-introspection=1.46.0-3ubuntu1 libcurl3-gnutls=7.47.0-1ubuntu2.19 libpng12-0=1.2.54-1ubuntu1.1 libxv1=2:1.0.10-1 libvisual-0.4-0=0.4.0-8 libgl1-mesa-glx=18.0.5-0ubuntu0~16.04.1 libpango-1.0-0=1.38.1-1 libtheora0=1.1.1+dfsg.1-8 libcdparanoia0=3.10.2+debian-11 libasound2=1.1.0-0ubuntu1 libsoup2.4-1=2.52.2-1ubuntu0.3 libjpeg8=8c-2ubuntu8 libjpeg-turbo8=1.4.2-0ubuntu3.4 python3=3.5.1-3 python3-pip=8.1.1-2ubuntu0.6 python-yaml=3.11-3build1 libgtk2.0 libdrm2=2.4.91-2~16.04.1 libxv1=2:1.0.10-1 -y -q ; rm -rf /var/lib/apt/lists/*
#   Install
