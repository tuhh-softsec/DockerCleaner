...
RUN printf "i686" > /etc/yum/vars/arch \
 ...
 && yum update -y \
 && yum install -y sudo wget git make glibc-devel gmp-devel mpfr-devel libmpc-devel nasm m4 libffi-devel pkgconfig subversion xz curl xz-devel tar devtoolset-7-toolchain zlib-devel bzip2 bzip2-devel readline-devel sqlite sqlite-devel tk-devel libffi-devel libtool perl-core help2man autoconf-archive \
 && yum clean all \
 ...
 && pip install conan==2.0.4 --no-cache-dir \
