...
RUN set -ex \
 ...
 && apk add pwgen openssl ca-certificates libstdc++ libaio gnutls ncurses-libs libcurl libxml2 boost proj4 geos alpine-sdk cmake ncurses-dev gnutls-dev curl-dev libxml2-dev libaio-dev linux-headers bison boost-dev --no-cache \
