...
EXPOSE 3838/tcp 7474/tcp 8787/tcp
#   ===================
#   --- Linux AND R ---
#   ===================
RUN echo "deb http://cran.rstudio.com/bin/linux/debian jessie-cran3/" >> /etc/apt/sources.list \
 ...
 && apt-get install --no-install-recommends libcurl4-openssl-dev libxml2-dev libssl-dev libpng-dev -y \
 && apt-get install --no-install-recommends jessie-backports ca-certificates-java openjdk-8-jre-headless -y -t \
 && apt-get install --no-install-recommends wget gdebi-core openjdk-8-jdk curl -y \
 && apt-get -y clean
...
#   =================================
COPY import.cql /var/tmp/
COPY DataGraph/data.csv //usr/local/neo4j/data/databases/graph.db/import/
COPY DataGraph/PPI.csv.gz //usr/local/neo4j/data/databases/graph.db/import/
COPY DataGraph/taxon.csv //usr/local/neo4j/data/databases/graph.db/import/
...
RUN R -e " devtools::install_github('End-to-end-provenance/RDataTracker'); "
...
#   ------------------
#   Affymetrix
COPY Annotation/GPL570.txt /home/rstudio/Annotation/
COPY Annotation/GPL571.txt /home/rstudio/Annotation/
COPY Annotation/GPL96.txt /home/rstudio/Annotation/
COPY Annotation/GPL6244.txt /home/rstudio/Annotation/
COPY Annotation/GPL3535.txt /home/rstudio/Annotation/
COPY Annotation/GPL6246.txt /home/rstudio/Annotation/
COPY Annotation/GPL1261.txt /home/rstudio/Annotation/
COPY Annotation/GPL570.txt /home/rstudio/Annotation/
COPY Annotation/GPL1355.txt /home/rstudio/Annotation/
#   ----------------------
#   --- Pre Processing ---
#   ----------------------
COPY Parameters.R /home/rstudio/
COPY Module-A/ModuleProcessingShiny.R /home/rstudio/Module-A/
COPY Module-A/Dependences.R /home/rstudio/Module-A/
COPY Module-A/ModuleProcessing.R /home/rstudio/Module-A/
COPY Module-A/cNodeExperiment.R /home/rstudio/Module-A/
COPY Module-A/cNodeValues.R /home/rstudio/Module-A/
COPY Module-A/Pre_Raw.R /home/rstudio/Module-A/
COPY Module-A/Pre_eSet.R /home/rstudio/Module-A/
COPY Module-A/Pre_Limma.R /home/rstudio/Module-A/
COPY Module-A/Pre_PosLimma.R /home/rstudio/Module-A/
COPY Module-A/MyStandardise.R /home/rstudio/Module-A/
COPY Module-A/Enrichment_GOStat2.R /home/rstudio/Module-A/
COPY Module-A/HeatMap3.R /home/rstudio/Module-A/
COPY Module-A/Pop_enrichment.R /home/rstudio/Module-A/
COPY Module-A/Clust_pop.R /home/rstudio/Module-A/
COPY Module-A/Clusterization.R /home/rstudio/Module-A/
COPY Module-A/GraphDataPersist.R /home/rstudio/Module-A/
COPY Module-A/PowerDetec.R /home/rstudio/Module-A/
COPY Module-A/AmdDetec.R /home/rstudio/Module-A/
USER root
CMD chmod -R 777 /home/rstudio \
