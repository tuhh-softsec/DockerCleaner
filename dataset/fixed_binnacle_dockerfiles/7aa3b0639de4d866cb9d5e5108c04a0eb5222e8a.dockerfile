...
RUN apt-get update \
 ...
 && apt-get install --no-install-recommends git=1:2.30.2-1+deb11u2 mercurial=5.6.1-4 xvfb=2:1.20.11-1+deb11u6 apt=2.2.4 locales=2.31-13+deb11u5 sudo=1.9.5p2-3+deb11u1 openssh-client=1:8.4p1-5+deb11u1 ca-certificates=20210119 tar=1.34+dfsg-1 gzip=1.10-4+deb11u1 parallel=20161222-1.1 net-tools=1.60+git20181103.0eebece-1 netcat=1.10-46 unzip=6.0-26+deb11u1 zip=3.0-12 bzip2=1.0.8-4 gnupg=2.2.27-2+deb11u2 curl=7.74.0-1.3+deb11u7 wget=1.21-1+deb11u1 make=4.3-4.1 -y
