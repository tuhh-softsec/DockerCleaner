...
RUN set -eux \
 ...
 && apk update \
 && apk add bash=4.4.19-r1 curl=7.64.0-r5 nginx=1.14.2-r5 php7-bcmath=7.2.33-r0 php7-ctype=7.2.33-r0 php7-fpm=7.2.33-r0 php7-gd=7.2.33-r0 php7-gettext=7.2.33-r0 php7-json=7.2.33-r0 php7-ldap=7.2.33-r0 php7-mbstring=7.2.33-r0 php7-pgsql=7.2.33-r0 php7-session=7.2.33-r0 php7-simplexml=7.2.33-r0 php7-sockets=7.2.33-r0 php7-xmlreader=7.2.33-r0 php7-xmlwriter=7.2.33-r0 postgresql-client=11.11-r0 supervisor=3.3.4-r1 ${APK_FLAGS_PERSISTENT} \
 && rm -rf /var/cache/apk/*
