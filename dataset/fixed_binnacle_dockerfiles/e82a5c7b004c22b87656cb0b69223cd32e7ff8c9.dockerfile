#   ==================================================================
#   cu90-py36-tf19-t2t110-torch041
...
RUN sed -i 's/archive.ubuntu.com/mirrors.ustc.edu.cn/g' /etc/apt/sources.list \
 ...
 && $PIP_INSTALL numpy h5py scipy pandas scikit-learn scikit-image scikit-video matplotlib Cython visdom dominate protobuf lmdb wheel nose leveldb Pillow six decorator==4.3.0 opencv-python sklearn imageio packaging tqdm urllib3 numba==0.41.0 seaborn==0.9.0 hypertools==0.5.1 fasteners fjcommon==0.1.69 \
 && $PIP_INSTALL tensorflow-gpu==1.9.0 tensor2tensor==1.10.0 tensorboardX==1.4 \
 && $PIP_INSTALL http://download.pytorch.org/whl/cu90/torch-0.4.1-cp36-cp36m-linux_x86_64.whl torchvision \
 && ldconfig \
 && apt-get clean \
 && apt-get autoremove \
