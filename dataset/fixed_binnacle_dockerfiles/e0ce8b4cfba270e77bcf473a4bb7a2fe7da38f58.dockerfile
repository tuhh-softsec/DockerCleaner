...
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends libass-dev=1:0.14.0-1 libfreetype6-dev=2.8.1-2ubuntu2.2 libsdl2-dev=2.0.8+dfsg1-1ubuntu1.18.04.4 libxcb1-dev=1.13-2~ubuntu18.04 libxcb-shm0-dev=1.13-2~ubuntu18.04 libxcb-xfixes0-dev=1.13-2~ubuntu18.04 texinfo=6.5.0.dfsg.1-2 zlib1g-dev=1:1.2.11.dfsg-0ubuntu2.2 libssl-dev=1.1.1-1ubuntu2.1~18.04.21 -y -q
