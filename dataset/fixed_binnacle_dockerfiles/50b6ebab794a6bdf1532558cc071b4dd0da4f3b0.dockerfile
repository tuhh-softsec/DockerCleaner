...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends build-essential=11.6ubuntu6 libsdl1.2-dev=1.2.15-8ubuntu1.1 zlib1g-dev=1:1.2.8.dfsg-1ubuntu1.1 libsdl-mixer1.2-dev=1.2.12-10 libsdl-image1.2-dev=1.2.12-5+deb9u1build0.14.04.1 git=1:1.9.1-1ubuntu0.10 curl=7.35.0-1ubuntu2.20 wget=1.15-1ubuntu1.14.04.5 ca-certificates=20170717~14.04.2 build-essential=11.6ubuntu6 -y \
...
COPY ./server.conf /redeclipse.tmpl
ENV SERVER_PASS="" \
    ADMIN_PASS="" \
    SERVER_TYPE="1" \
...
EXPOSE 28799/tcp 28800/tcp 28801/tcp 28802/tcp
RUN cd /redeclipse/src/ \
 && make install
