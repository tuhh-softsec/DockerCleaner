...
WORKDIR /home
#   Prerequisites
RUN yum install -y epel-release ; yum install -y -q numactl openssl glib2-2.56.1 pango gobject-introspection libpng12 libXv libvisual mesa-libGL pango glib2 alsa-lib libsoup libjpeg-turbo ; yum remove -y -q epel-release ; rm -rf /var/cache/yum/*
#   Install
