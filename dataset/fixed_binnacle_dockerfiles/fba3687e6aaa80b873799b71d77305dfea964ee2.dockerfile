...
RUN apk update \
 && apk upgrade \
 && apk add bzip2=1.0.6-r7 docker=18.06.1-r0 sudo=1.8.23-r4 git=2.18.4-r0 iptables=1.6.2-r0 jq=1.6_rc1-r1 openrc=0.35.5-r5 openssh-client=7.7_p1-r4 shadow=4.5-r0 unzip=6.0-r6 zip=3.0-r6
