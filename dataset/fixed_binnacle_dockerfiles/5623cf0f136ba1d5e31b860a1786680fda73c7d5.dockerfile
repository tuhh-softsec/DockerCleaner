...
RUN (apt-get update ;apt-get install --no-install-recommends php7.0=7.0.33-0+deb9u12 php7.0-curl=7.0.33-0+deb9u12 php7.0-bcmath=7.0.33-0+deb9u12 php7.0-bz2=7.0.33-0+deb9u12 php7.0-dev=7.0.33-0+deb9u12 php7.0-gd=7.0.33-0+deb9u12 php7.0-dom php7.0-imap=7.0.33-0+deb9u12 php7.0-intl=7.0.33-0+deb9u12 php7.0-imagick php7.0-json=7.0.33-0+deb9u12 php7.0-ldap=7.0.33-0+deb9u12 php7.0-mbstring=7.0.33-0+deb9u12 php7.0-mcrypt=7.0.33-0+deb9u12 php7.0-mysql=7.0.33-0+deb9u12 php7.0-oauth php7.0-odbc=7.0.33-0+deb9u12 php7.0-uploadprogress php7.0-ssh2 php7.0-xml=7.0.33-0+deb9u12 php7.0-zip=7.0.33-0+deb9u12 php7.0-solr php7.0-apcu php7.0-opcache=7.0.33-0+deb9u12 php7.0-memcache php7.0-memcached php7.0-redis php7.0-xdebug libapache2-mod-php7.0=7.0.33-0+deb9u12 -yqq )
...
RUN echo "extension=apcu.so" > /etc/php/7.0/mods-available/apcu_bc.ini \
...
RUN a2enmod access_compat actions alias auth_basic authn_core authn_file authz_core authz_groupfile authz_host authz_user autoindex dir env expires filter headers mime negotiation php7.0 mpm_prefork reqtimeout rewrite setenvif status ssl
