...
RUN apt-get update \
 && apt-get install --no-install-recommends python3-software-properties=0.96.20.10 python3-pip=8.1.1-2ubuntu0.6 software-properties-common=0.96.20.10 postgresql-9.3 postgresql-client-9.3 postgresql-contrib-9.3 postgresql-server-dev-9.3 rubygems -y \
