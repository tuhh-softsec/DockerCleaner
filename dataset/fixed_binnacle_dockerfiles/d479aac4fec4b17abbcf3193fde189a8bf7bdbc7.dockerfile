...
RUN apt-get update \
 && apt-get install --no-install-recommends acl=2.3.1-3 dirmngr=2.2.40-1ubuntu2 gpg=2.2.40-1ubuntu2 lsof=4.95.0-1 procps=2:4.0.3-1ubuntu1 wget=1.21.3-1ubuntu1 -y \
