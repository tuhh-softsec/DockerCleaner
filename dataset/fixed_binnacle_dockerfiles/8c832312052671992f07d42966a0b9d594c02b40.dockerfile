...
RUN apt-get update -qq \
 && apt-get install --no-install-recommends apache2=2.4.7-1ubuntu4.22 openssl=1.0.1f-1ubuntu2.27 php5=5.5.9+dfsg-1ubuntu4.29 php5-cli=5.5.9+dfsg-1ubuntu4.29 php5-gd=5.5.9+dfsg-1ubuntu4.29 php5-mysql=5.5.9+dfsg-1ubuntu4.29 php-pear=5.5.9+dfsg-1ubuntu4.29 php5-curl=5.5.9+dfsg-1ubuntu4.29 postfix=2.11.0-1ubuntu1.2 sudo=1.8.9p5-1ubuntu1.4 rsync=3.1.0-2ubuntu0.4 git-core=1:1.9.1-1ubuntu0.10 unzip=6.0-9ubuntu1.5 wget=1.15-1ubuntu1.14.04.5 mysql-client=5.5.62-0ubuntu0.14.04.1 -y -qq
ENV AEGIR_UID="1000"
