...
COPY $REMOTE_PACKAGES_PATH/V45999-01.zip $BASE_CONTAINER_PACKAGES_PATH/V45999-01.zip
#  OCmdex6.5.1-Linux64_829811.sh
COPY $REMOTE_PACKAGES_PATH/V46002-01.zip $BASE_CONTAINER_PACKAGES_PATH/V46002-01.zip
#   Tools And Frameworks
COPY $REMOTE_PACKAGES_PATH/V46389-01.zip $BASE_CONTAINER_PACKAGES_PATH/V46389-01.zip
#  ######################################
#   Copy script that creates unique password for root and other scripts
COPY $REMOTE_SCRIPTS_PATH/setupEndecaUser.sh $BASE_CONTAINER_TMP_PATH/setupEndecaUser.sh
RUN chmod +x $BASE_CONTAINER_TMP_PATH/setupEndecaUser.sh
#  ######################################
#   Copy silent install scripts
COPY $REMOTE_SUPPORTS_PATH/platformservices-silent.txt $BASE_CONTAINER_TMP_PATH/platformservices-silent.txt
#  ######################################
