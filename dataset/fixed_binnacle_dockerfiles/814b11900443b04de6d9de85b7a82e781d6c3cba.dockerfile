...
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends libass-dev=0.13.1-1 libfreetype6-dev=2.6.1-0.1ubuntu2.5 libvdpau-dev=1.1.1-3ubuntu1 libsdl2-dev=2.0.4+dfsg1-2ubuntu2.16.04.2 libxcb1-dev=1.11.1-1ubuntu1 libxcb-shm0-dev=1.11.1-1ubuntu1 libxcb-xfixes0-dev=1.11.1-1ubuntu1 zlib1g-dev=1:1.2.8.dfsg-2ubuntu4.3 libssl-dev=1.0.2g-1ubuntu4.20 -y -q
...
#   Prerequisites
RUN DEBIAN_FRONTEND=noninteractive apt-get update \
 && apt-get install --no-install-recommends libxv1=2:1.0.10-1 libxcb-shm0=1.11.1-1ubuntu1 libxcb-shape0=1.11.1-1ubuntu1 libxcb-xfixes0=1.11.1-1ubuntu1 libsdl2-2.0-0=2.0.4+dfsg1-2ubuntu2.16.04.2 libasound2=1.1.0-0ubuntu1 libvdpau1=1.1.1-3ubuntu1 libnuma1=2.0.11-1ubuntu1.1 libass5=0.13.1-1 libssl1.0.0=1.0.2g-1ubuntu4.20 libdrm2=2.4.91-2~16.04.1 -y -q ; rm -rf /var/lib/apt/lists/*
#   Install
