...
RUN set -eux \
 ...
 && apk update \
 && apk add tini=0.18.0-r0 bash=4.4.19-r1 fping=4.1-r0 iputils=20180629-r1 libcurl=7.64.0-r5 libevent=2.1.8-r6 libldap=2.4.48-r2 libssh2=1.9.0-r1 libxml2=2.9.9-r3 net-snmp-agent-libs=5.8-r1 openipmi-libs=2.0.25-r1 pcre=8.42-r2 postgresql-client=11.11-r0 postgresql-libs=11.11-r0 unixodbc=2.3.7-r0 ${APK_FLAGS_PERSISTENT} \
 && rm -rf /var/cache/apk/*
