...
COPY hadoop-native-64-2.7.1.tar /usr/local/hadoop/lib/native/
...
COPY config/mapred-site.xml $HADOOP_PREFIX/etc/hadoop/mapred-site.xml
...
COPY graphs/google-multiple $HADOOP_PREFIX/google-4P
COPY graphs/fb-input $HADOOP_PREFIX/facebook-1P
COPY graphs/fb-multiple $HADOOP_PREFIX/facebook-4P
COPY graphs/ca-road-network-4P $HADOOP_PREFIX/ca_road_network-4P
#  HAMA ENV VARIABLES
...
#   Hdfs ports
EXPOSE 50010/tcp 50020/tcp 50070/tcp 50075/tcp 50090/tcp 19888/tcp 8030/tcp 8031/tcp 8032/tcp 8033/tcp 8040/tcp 8042/tcp 8088/tcp 49707/tcp 2122/tcp
#   Mapred ports
#  EXPOSE 19888
#  Yarn ports
