...
RUN apt-get update -yqq \
 && apt-get install --no-install-recommends ca-certificates=20211016ubuntu0.18.04.1 expat=2.2.5-3ubuntu0.9 libgomp1=8.4.0-1ubuntu1~18.04 -yq \
...
RUN buildDeps="autoconf automake cmake curl bzip2 libexpat1-dev g++ gcc git gperf libtool make nasm perl pkg-config python libssl-dev yasm libva-dev zlib1g-dev" \
 && apt-get update -yqq \
...
RUN apt-get update -y \
 && apt-get install --no-install-recommends libva-drm2=2.1.0-3 libva2=2.1.0-3 i965-va-driver=2.1.0-0ubuntu1 -y \
