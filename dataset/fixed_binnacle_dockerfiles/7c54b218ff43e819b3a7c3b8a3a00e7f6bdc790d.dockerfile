...
RUN apt-get update \
 && apt-get install --no-install-recommends openssh-server=1:6.6p1-2ubuntu2.13 openjdk-7-jdk=7u211-2.6.17-0ubuntu0.1 wget=1.15-1ubuntu1.14.04.5 vim=2:7.4.052-1ubuntu3.1 zip=3.0-8 -y
