...
RUN set -x \
 ...
 && apk add php7-common=7.1.33-r0 php7-iconv=7.1.33-r0 php7-json=7.1.33-r0 php7-gd=7.1.33-r0 php7-curl=7.1.33-r0 php7-xml=7.1.33-r0 php7-pgsql=7.1.33-r0 php7-imap=7.1.33-r0 php7-cgi=7.1.33-r0 fcgi=2.4.0-r8 \
