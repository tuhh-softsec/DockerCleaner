...
RUN (apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 44FC67F19B2466EA || apt-key adv --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys 44FC67F19B2466EA ) \
 ...
 && apt-get update \
 && apt-get install --no-install-recommends curl=7.58.0-2ubuntu3.24 gcc=4:7.4.0-1ubuntu2.3 git=1:2.17.1-1ubuntu0.17 libssl-dev=1.1.1-1ubuntu2.1~18.04.21 libzmq3-dev=4.2.5-1ubuntu0.2 openssl=1.1.1-1ubuntu2.1~18.04.21 pkg-config=0.29.1-0ubuntu2 python3=3.6.7-1~18.04 python3-grpcio-tools python3-sawtooth-cli unzip=6.0-21ubuntu1.2 -y -q \
