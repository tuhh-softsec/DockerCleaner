...
RUN apt-get update \
 && apt-get install --no-install-recommends build-essential=12.4ubuntu1 curl=7.58.0-2ubuntu3.24 git=1:2.17.1-1ubuntu0.17 libcurl3-dev libfreetype6-dev=2.8.1-2ubuntu2.2 libhdf5-serial-dev=1.10.0-patch1+docs-4 libpng-dev=1.6.34-1ubuntu0.18.04.2 libzmq3-dev=4.2.5-1ubuntu0.2 pkg-config=0.29.1-0ubuntu2 python-dev=2.7.15~rc1-1 rsync=3.1.2-2.1ubuntu1.6 software-properties-common=0.96.24.32.20 unzip=6.0-21ubuntu1.2 zip=3.0-11build1 zlib1g-dev=1:1.2.11.dfsg-0ubuntu2.2 openjdk-8-jdk=8u362-ga-0ubuntu1~18.04.1 openjdk-8-jre-headless=8u362-ga-0ubuntu1~18.04.1 -y \
 && apt-get clean \
