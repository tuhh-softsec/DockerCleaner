...
RUN apt-get update \
 && (apt-get update ;apt-get install --no-install-recommends liblzma-dev=5.4.1-0.2 libpng-dev=1.6.39-2 wget=1.21.3-1ubuntu1 -y )
...
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/pubfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/zipfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/cdrfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/vsdfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/zmffuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/pmdfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/fhfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/cmxfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/sdcfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/bmifuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/abwfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/sdafuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/sddfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/sdwfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/key6fuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/vsdxfuzzer_seed_corpus.zip
RUN which wget &> /dev/null || (apt-get update ;apt-get install --no-install-recommends wget=1.20.3 ) ; wget --no-verbose --output-document $SRC/ https://dev-www.libreoffice.org/corpus/vdxfuzzer_seed_corpus.zip
