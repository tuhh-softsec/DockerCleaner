...
RUN GPG_KEYS=B0F4253373F8F6F510D42178520A9993A1C052F8 \
 ...
 && apk add gcc=8.3.0-r0 libc-dev=0.7.1-r0 make=4.2.1-r2 openssl-dev=1.1.1k-r0 pcre-dev=8.42-r2 zlib-dev=1.2.11-r1 linux-headers=4.18.13-r1 curl=7.64.0-r5 gnupg=2.2.19-r0 libxslt-dev=1.1.33-r3 gd-dev=2.2.5-r4 geoip-dev=1.6.12-r1 perl-dev=5.26.3-r1 --no-cache --virtual .build-deps \
 && apk add pcre-dev=8.42-r2 libxml2-dev=2.9.9-r3 git=2.20.4-r0 libtool=2.4.6-r5 automake=1.16.1-r0 autoconf=2.69-r2 g++=8.3.0-r0 flex=2.6.4-r1 bison=3.0.5-r0 yajl-dev=2.1.0-r0 --no-cache --virtual .libmodsecurity-deps \
 && apk add yajl=2.1.0-r0 libstdc++=8.3.0-r0 --no-cache \
