...
#   Install XDebug
RUN (pecl install xdebug || pecl install xdebug-2.5.5 || pecl install xdebug-2.7.1 ) \
 && docker-php-ext-enable xdebug
#   Install common extensions
RUN apt-get install --no-install-recommends libicu-dev zlib1g-dev libzip-dev -y
