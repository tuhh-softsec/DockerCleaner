...
RUN set -ex \
 && apk update \
 && apk upgrade \
 && apk add bash=4.4.19-r1 tzdata=2020a-r0 vim=8.1.1365-r0 tini=0.18.0-r0 su-exec=0.2-r0 gnupg=2.2.19-r0 gzip=1.9-r0 shadow=4.5-r0 tar=1.32-r0 wget=1.20.3-r0 curl=7.61.1-r3 \
