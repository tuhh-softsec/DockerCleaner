...
RUN apk add ca-certificates=20190108-r0 openssl=1.0.2t-r0 --no-cache \
 && apk add wget=1.20.3-r0 ca-certificates=20190108-r0 --no-cache \
...
RUN apk add php7.1@php php7.1-common@php php7.1-memcached@php php7.1-curl@php php7.1-dom@php php7.1-exif@php php7.1-ftp@php php7.1-gd@php php7.1-iconv@php php7.1-mbstring@php php7.1-mysqli@php php7.1-mysqlnd@php php7.1-openssl@php php7.1-pdo@php php7.1-session@php php7.1-posix@php php7.1-soap@php php7.1-zip@php php7.1-ldap@php php7.1-bcmath@php php7.1-calendar@php php7.1-gettext@php php7.1-json@php php7.1-pcntl@php php7.1-apcu@php php7.1-phar@php php7.1-sockets@php php7.1-tidy@php php7.1-wddx@php php7.1-xmlreader@php php7.1-zip@php php7.1-tokenizer@php php7.1-zlib@php php7.1-xsl@php php7.1-opcache@php php7.1-imagick@php php7.1-ctype@php php7.1-pdo_mysql@php php7.1-pdo_sqlite@php php7.1-sqlite3@php php7.1-redis@php php7.1-intl@php php7.1-fpm@php --no-cache
#   These only exist in 7.1, not 7.2
RUN apk add php7-mcrypt@php php7-xmlrpc@php --no-cache
#   Imagick support file types
RUN apk add imagemagick=7.0.7.11-r1 --no-cache
RUN mv /etc/php/7.1 /tmp/7.1 \
 && rm -rf /etc/php \
 && rm -rf /etc/php7 \
 && mv /tmp/7.1 /etc/php7 \
