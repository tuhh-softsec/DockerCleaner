...
RUN apt-get update -y \
 && apt-get install --no-install-recommends wget=1.17.1-1ubuntu1.5 git=1:2.7.4-0ubuntu1.10 g++=4:5.3.1-1ubuntu1 make=4.1-6 curl=7.47.0-1ubuntu2.19 libssl-dev=1.0.2g-1ubuntu4.20 libevent-dev=2.0.21-stable-2ubuntu0.16.04.1 libcurl4-openssl-dev=7.47.0-1ubuntu2.19 libsnappy-dev=1.1.3-2 ncurses-dev openssl=1.0.2g-1ubuntu4.20 libiodbc2-dev=3.52.9-2 autoconf=2.69-9 cmake=3.5.1-1ubuntu3 libtool=2.4.6-0.1 python=2.7.12-1~16.04 python-dev=2.7.12-1~16.04 golang-go=2:1.6-1ubuntu4 subversion=1.9.3-2ubuntu1.3 cmake=3.5.1-1ubuntu3 gnupg=1.4.20-1ubuntu3.3 openjdk-8-jdk=8u292-b10-0ubuntu1~16.04.1 openjdk-8-jre=8u292-b10-0ubuntu1~16.04.1 lsb-release=9.20160110ubuntu0.2 -y \
 && cd $WDIR \
 ...
 && make install \
 && cd .. \
 && apt-get remove -y wget git make curl autoconf cmake libtool subversion cmake lsb-release \
