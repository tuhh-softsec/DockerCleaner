...
ENV ELASTICSEARCH_DEB_VERSION="6.4.3"
#   copy source code
RUN wget -q https://github.com/elastic/elasticsearch/archive/v6.4.3.tar.gz -O /usr/local/src/elasticsearch-source-v6.4.3.tar.gz
RUN set -x \
