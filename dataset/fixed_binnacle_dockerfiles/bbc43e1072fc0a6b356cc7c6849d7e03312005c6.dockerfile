...
RUN mkdir ncurses \
 ...
 && CC=/x-tools/x86_64-unknown-linux-musl/bin/x86_64-unknown-linux-musl-cc CXX=/x-tools/x86_64-unknown-linux-musl/bin/x86_64-unknown-linux-musl-c++ ../configure --prefix=/x-tools/x86_64-unknown-linux-musl/x86_64-unknown-linux-musl/sysroot/usr --host=x86_64-unknown-linux-musl $( cat /ncurses.conf ;) \
 && make install.libs ) \
...
RUN git clone https://github.com/tpoechtrager/osxcross.git \
 ...
 && curl -sfSL https://s3.dockerproject.org/darwin/v2/MacOSX10.10.sdk.tar.xz -O ) \
...
RUN apt-get purge -y apt-transport-https automake autopoint bzip2 file flex gawk gettext golang gperf help2man python rsync texinfo \
 && apt-get autoremove -y
