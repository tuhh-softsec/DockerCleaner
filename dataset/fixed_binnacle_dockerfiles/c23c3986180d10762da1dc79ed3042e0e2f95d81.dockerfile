...
RUN apt-get update \
 && apt-get install --no-install-recommends ca-certificates=20230311 git=1:2.39.2-1ubuntu1 procps=2:4.0.3-1ubuntu1 libpcre3=2:8.39-15 openssl=3.0.8-1ubuntu1 libssl-dev=3.0.8-1ubuntu1 zlib1g=1:1.2.13.dfsg-1ubuntu4 v4l-utils=1.22.1-5build1 libv4l-0=1.22.1-5build1 alsa-utils=1.2.8-1ubuntu1 -y
COPY . /restreamer
WORKDIR /restreamer
RUN cd /restreamer \
