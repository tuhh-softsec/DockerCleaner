...
RUN apt-get update \
 && apt-get install --no-install-recommends acl=2.2.53-10 dirmngr=2.2.27-2+deb11u2 gpg=2.2.27-2+deb11u2 lsof=4.93.2+dfsg-1.1 procps=2:3.3.17-5 wget=1.21-1+deb11u1 -y \
