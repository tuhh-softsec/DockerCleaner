...
COPY $LOCAL_TOOLS/V35742-01.zip $BASE_TMP_PACKAGE_INSTALL/V35742-01.zip
#  platformservices_613654721_x86_64pc-linux.sh
COPY $LOCAL_TOOLS/V33316-01.zip $BASE_TMP_PACKAGE_INSTALL/V33316-01.zip
#  text file used for silent install of platform services
COPY $LOCAL_TOOLS/platformservices-silent.txt $BASE_TMP_ENDECA_INSTALL/platformservices-silent.txt
#  cas-3.1.1-x86_64pc-linux.sh
COPY $LOCAL_TOOLS/V35739-01.zip $BASE_TMP_PACKAGE_INSTALL/V35739-01.zip
#  text file used or silent install of platform services
COPY $LOCAL_TOOLS/cas-silent.txt $BASE_TMP_ENDECA_INSTALL/cas-silent.txt
#  gs_3.1.1.6904_linux.zip 
COPY $LOCAL_TOOLS/V35740-01.zip $BASE_TMP_PACKAGE_INSTALL/V35740-01.zip
#  xmgr_3.1.1.6904_linux.zip 
COPY $LOCAL_TOOLS/V35744-01.zip $BASE_TMP_PACKAGE_INSTALL/V35744-01.zip
#  relevancy ranking tool
COPY $LOCAL_TOOLS/V31171-01.zip $BASE_TMP_PACKAGE_INSTALL/V31171-01.zip
#  ######################################
...
COPY tools/ws-extensions.xml $BASE_ENDECA_DIR/ToolsAndFrameworks/3.1.1/server/workspace/conf/ws-extensions.xml
#   place correct menu items
COPY tools/ws-mainMenu.xml $BASE_ENDECA_DIR/ToolsAndFrameworks/3.1.1/server/workspace/conf/ws-mainMenu.xml
#  ######################################
