...
#   Score: 10/10
RUN npm install ep_clear_formatting@0.0.20
...
#   Score: 8/10
RUN npm install ep_fileupload@0.0.12
...
RUN npm install ep_previewimages@0.0.13
...
#   Score: 10/10
RUN npm install ep_linkify@0.1.1
...
#   Score: 6/10
RUN npm install ep_prompt_for_name@1.0.20
...
RUN npm install ep_special_characters@0.0.22
...
RUN npm install ep_syntaxhighlighting@0.1.5
