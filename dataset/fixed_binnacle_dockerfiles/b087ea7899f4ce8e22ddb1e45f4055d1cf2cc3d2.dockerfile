...
ENV RUST_CONFIGURE_ARGS="--enable-full-tools  --enable-sanitizers  --enable-profiler  --set target.i686-unknown-linux-gnu.linker=clang  --build=i686-unknown-linux-gnu  --set rust.jemalloc"
