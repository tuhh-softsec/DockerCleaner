...
#   Download
RUN apk add ca-certificates=20191127-r2 curl=7.64.0-r5 --no-cache \
 && pwd \
 && curl -sSL https://download.kopano.io/community/konnect:/kopano-konnect-${VERSION}.tar.gz | tar -C /var/lib/konnectd-docker --strip 1 -vxzf - \
