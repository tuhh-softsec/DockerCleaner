...
ENV DEL_LIB_PHP_DIR="/usr/lib/php/20131226  /usr/lib/php/20151012  /usr/lib/php/20170718  /usr/lib/php/20180731  /usr/lib/php/${PHP_VER}"
#   Deletable extra directories that may be created by installing PHP modules
ENV DEL_PHP_DIR="/etc/php/5.6  /etc/php/7.0  /etc/php/7.2  /etc/php/7.3"
