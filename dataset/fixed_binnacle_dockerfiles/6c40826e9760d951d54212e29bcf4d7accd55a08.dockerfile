...
RUN set -ex \
 ...
 && rm python.tar.xz \
 && apk add bzip2-dev=1.0.6-r7 coreutils=8.31-r0 dpkg-dev=1.19.7-r0 dpkg=1.19.7-r0 expat-dev=2.2.8-r0 findutils=4.6.0-r1 gcc=8.3.0-r0 gdbm-dev=1.13-r1 libc-dev=0.7.1-r0 libffi-dev=3.2.1-r6 linux-headers=4.19.36-r0 make=4.2.1-r2 ncurses-dev=6.1_p20190518-r2 openssl-dev=1.1.1k-r0 pax-utils=1.2.3-r0 readline-dev=8.0.0-r0 sqlite-dev=3.28.0-r3 tcl-dev=8.6.9-r0 tk=8.6.9-r0 tk-dev=8.6.9-r0 xz-dev=5.2.4-r0 zlib-dev=1.2.11-r1 --no-cache --virtual .build-deps \
 && apk del .fetch-deps \
 && cd /usr/src/python \
